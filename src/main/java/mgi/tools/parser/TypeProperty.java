...
public enum TypeProperty {
    ...
    static {
        Utils.populateMap(values, properties = new Object2ObjectOpenHashMap<>(values.length), TypeProperty::getField);
    }
    ...
    TypeProperty(final String identifier, final String field) {
        this.identifier = identifier;
        this.field = field;
    }
}
