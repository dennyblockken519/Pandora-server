 ...
 */
public class GameNoticeboard extends ComponentDefinitions {
    public ArrayList<ComponentDefinitions> assemble(final int interfaceId) {
        ...
        component.setPosition(0, 0);
        component.setSize(164, 229);
        component.setOnScrollWheelListener(new Object[]{36, interfaceId << 16 | componentId + 1, interfaceId << 16 | componentId, -2147483646});
        add(componentId++, component);
        component = new LayerComponent();
        component.setParentId(0);
        ...
        component.setOnScrollWheelListener(new Object[]{36, interfaceId << 16 | componentId, interfaceId << 16 | componentId - 1});
        add(componentId++, component);
        ...
        for (int i = 0; i < serverNodes; i++) {
            ...
            if (i == 0 || i == 2) {
                if (i == 0) {
                    ...
                    component.setOnVarTransmitListener(new Object[]{3502, ((701 << 16) | 8), ((701 << 16) | 9), ((701 << 16) | 10)});
                ...
                component.setOnLoadListener(new Object[]{3500, ((701 << 16) | 11), ((701 << 16) | 16), ((701 << 16) | 31), ((701 << 16) | 32), 1});
            }
            component.setParentId(4);
