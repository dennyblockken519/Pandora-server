...
public interface Definitions {
    Class<?>[] HIGH_PRIORITY_DEFINITIONS = new Class<?>[]{ObjectDefinitions.class, NPCDefinitions.class, ItemDefinitions.class, AnimationDefinitions.class};
    Class<?>[] LOW_PRIORITY_DEFINITIONS = new Class<?>[]{EnumDefinitions.class, GraphicsDefinitions.class, IdentityKitDefinitions.class, InventoryDefinitions.class, OverlayDefinitions.class, ParamDefinitions.class, ClientScriptDefinitions.class, SkeletonDefinitions.class, UnderlayDefinitions.class, VarbitDefinitions.class, ComponentDefinitions.class, HitbarDefinitions.class, MapElementDefinitions.class, StructDefinitions.class, SpriteGroupDefinitions.class};
