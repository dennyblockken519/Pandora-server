...
public interface Enums {
    ...
    IntEnum BOUNTY_HUNTER_REWARDS = EnumDefinitions.getIntEnum(1974);
    ...
    StringEnum TASK_NAMES_ENUM = EnumDefinitions.getStringEnum(834);
    ...
    IntEnum TOURNAMENT_ITEMS_ENUM = EnumDefinitions.getIntEnum(2522);
