...
public abstract class WorldMapNode {
    ...
    public static int method2019(double var0, double var2, double var4) {
        double var6 = var4;
        double var8 = var4;
        double var10 = var4;
        if (var2 != 0.0) {
    ...
    private void decodeLarge(int x, int y, final ByteBuffer areaBuffer) {
        ...
        if (containsOverlays) {
            ...
            for (int plane = 0; plane < overlayTileHeights[x][y]; plane++) {
                final int id = areaBuffer.readUnsignedByte();
                if (id != 0) {
    ...
    public void setMinPlane(final int minPlane) {
        this.minPlane = minPlane;
    }

    public void setMaxPlane(final int maxPlane) {
        this.maxPlane = maxPlane;
    }

    public void setCenterRegionX(final int centerRegionX) {
        this.centerRegionX = centerRegionX;
    }

    public void setCenterRegionY(final int centerRegionY) {
    ...
    public void setUnderlays(final short[][][] underlays) {
        this.underlays = underlays;
    }

    public void setOverlays(final short[][][] overlays) {
        this.overlays = overlays;
    }

    public void setOverlayShapes(final byte[][][] overlayShapes) {
        this.overlayShapes = overlayShapes;
    }

    public void setOverlayRotations(final byte[][][] overlayRotations) {
        this.overlayRotations = overlayRotations;
    }

    public void setObjects(final WorldMapGameObject[][][][] objects) {
    ...
    public void setOverlayTileHeights(final int[][] overlayTileHeights) {
        this.overlayTileHeights = overlayTileHeights;
    }

    public void setOffsetChunksX(final int offsetChunksX) {
        this.offsetChunksX = offsetChunksX;
    }

    public void setOffsetChunksY(final int offsetChunksY) {
