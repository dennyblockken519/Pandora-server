...
public class CorporealBeastProcessor extends DropProcessor {
    ...
    public void attach() {
        ...
        //Spectral sigil
        appendDrop(new DisplayedDrop(12823, 1, 1, 1024));
        //Arcane sigil
        appendDrop(new DisplayedDrop(12827, 1, 1, 1024));
        //Elysian sigil
        appendDrop(new DisplayedDrop(12819, 1, 1, 3071));
    }
