...
public class CommanderZilyanaProcessor extends DropProcessor {
    ...
    public void attach() {
        //Saradomin sword
        appendDrop(new DisplayedDrop(11838, 1, 1, 95));
        //Saradomin's light
        appendDrop(new DisplayedDrop(13256, 1, 1, 190));
        //Armadyl crossbow
        appendDrop(new DisplayedDrop(11785, 1, 1, 381));
        //Saradomin hilt
        appendDrop(new DisplayedDrop(11814, 1, 1, 381));
        //Godsword shards
