        ...
        bind("Talk-to", (player, npc) -> {
            ...
            player.getDialogueManager().start(new Dialogue(player, npc) {
                ...
                public void buildDialogue() {
                    ...
                    options(TITLE, "Could you make a dragonfire shield?", "Can I buy some equipment?")
                            .onOptionOne(() -> setKey(5))
                            .onOptionTwo(() -> Shop.get("Oziach's Armour", false, player).open(player));
                    ...
                    if (!player.getInventory().containsItem(VISAGE)) {
                        ...
                        options("Are you sure you want to make a dragonfire shield?", "Yes.", "No,")
                                .onOptionOne(() -> {
