    ...
    public void handle() {
        bind("Talk-to", (player, npc) -> player.getDialogueManager().start(new Dialogue(player, npc) {
            ...
            public void buildDialogue() {
                ...
                options(TITLE, "Yes please!", "Oh, it's a rune shop. No thank you, then.", "Can you teleport me to " +
                        "the Rune Essence?").onOptionOne(() -> player.openShop("Aubury's Rune Shop")).onOptionTwo(() -> setKey(5)).onOptionThree(() -> setKey(10));
