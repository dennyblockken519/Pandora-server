...
public class MonkOfEntrana extends NPCPlugin {
    ...
    private static boolean isJewellery(final Item item) {
    ...
    public static boolean isForbiddenOnEntrana(@Nullable final Item item) {
    ...
    @Override
    public int[] getNPCs() {
        return new int[]{1165, 1166, 1167, 1168, 1169};
    }
}
