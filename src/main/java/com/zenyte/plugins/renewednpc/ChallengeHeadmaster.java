            ...
            public void handle(Player player, NPC npc) {
                ...
                player.getDialogueManager().start(new Dialogue(player, npc) {
                    ...
                    public void buildDialogue() {
                        ...
                        options(TITLE, "Who are you?", "What are daily challenges?", "I'd like to view my challenges.")
                                .onOptionOne(() -> setKey(5))
                                .onOptionTwo(() -> setKey(10))
                                .onOptionThree(() -> viewChallenges(player));
                        npc(5, "I'm the Challenge Headmaster. I'm basically the one that sees over the daily challenges. You can come to me whenever you complete a daily challenge for rewards.")
                                .executeAction(() -> setKey(2));
                        ...
                        npc("This also means the harder the objective, the better rewards you will get.")
                                .executeAction(() -> setKey(2));
                    }
                });
            }
