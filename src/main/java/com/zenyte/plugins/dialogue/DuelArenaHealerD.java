...
public class DuelArenaHealerD extends Dialogue {
    ...
    public void buildDialogue() {
        if (heal) {
            ...
            player(0, "Hi!");
            if (npc.getId() != 3344) { // nurses
                npc(1, "Hi. How can I help?");
                options(2, TITLE, "Can you heal me?", "Do you see a lot of injured fighters?", "Do you come here often?",
                        (npc.getId() == 3343 && player.getMaxHitpoints() >= 99 ? "Can I buy a Skillcape of Hitpoints from you?" : "")).
                        onOptionOne(() -> setKey(5)).
                        onOptionTwo(() -> setKey(10)).
                        onOptionThree(() -> setKey(15)).
                        onOptionFour(() -> setKey(19));
                ...
                options(20, TITLE, "Skill cape", "Hood").
                        onOptionOne(() -> setKey(25)).
                ...
                options(28, TITLE, "Sure, that's not too expensive for such a magnificent cape.", "Sorry, that's much too pricey.").
                        onOptionOne(() -> setKey(30)).
                        onOptionTwo(() -> setKey(34));
                ...
                options(2, TITLE, "Can you heal me?", "You must see some gruesome things?", "Why do they call you 'The Butcher'?").
                        onOptionOne(() -> Healer.heal(player, npc, true)).
                        onOptionTwo(() -> setKey(10)).
                        onOptionThree(() -> setKey(15));
