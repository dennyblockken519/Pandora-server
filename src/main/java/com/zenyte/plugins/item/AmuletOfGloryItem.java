...
public class AmuletOfGloryItem extends ItemPlugin {
    ...
    private enum AmuletOfGlory {
        ONE(new Item(1706), new Item(1704), 1),
        TWO(new Item(1708), new Item(1706), 2),
        THREE(new Item(1710), new Item(1708), 3),
        FOUR(new Item(1712), new Item(1710), 4),
        FIVE(new Item(11976), new Item(1712), 5),
        SIX(new Item(11978), new Item(11976), 6),
        ETERNAL(new Item(19707), null, -1),
        ONE_TRIM(new Item(10360), new Item(10362), 1),
        TWO_TRIM(new Item(10358), new Item(10360), 2),
        THREE_TRIM(new Item(10356), new Item(10358), 3),
        FOUR_TRIM(new Item(10354), new Item(10356), 4),
        FIVE_TRIM(new Item(11966), new Item(10354), 5),
        SIX_TRIM(new Item(11964), new Item(11966), 6);
        ...
        private static AmuletOfGlory get(@NotNull final Item item) {
            return Objects.requireNonNull(amulets.get(item.getId()));
        }

        AmuletOfGlory(final Item item, final Item result, final int charges) {
            this.item = item;
            this.result = result;
    ...
    private static final class GloryTeleport implements Teleport {
        ...
        public void onArrival(final Player player) {
            ...
            final String message = charges == 1 ? "<col=7F00FF>You use your amulet's last charge.</col>" : charges == 2 ? "<col=7F00FF>Your amulet has one charge left.</col>" : item.getId() != 19707 ? "<col=7F00FF>Your amulet has " + Utils.format(charges - 1) + " charges left.</col>" : "<col=7F00FF>No charges were used since the amulet holds unlimited charges.";
        ...
        public GloryTeleport(final Item item, final Container container, final int slotId, final Location destination) {
            this.item = item;
