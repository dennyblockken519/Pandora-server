...
public class GamesNecklaceItem extends ItemPlugin {
    ...
    private enum GamesNecklace {
        ONE(new Item(3867), null, 1),
        TWO(new Item(3865), new Item(3867), 2),
        THREE(new Item(3863), new Item(3865), 3),
        FOUR(new Item(3861), new Item(3863), 4),
        FIVE(new Item(3859), new Item(3861), 5),
        SIX(new Item(3857), new Item(3859), 6),
        SEVEN(new Item(3855), new Item(3857), 7),
        EIGHT(new Item(3853), new Item(3855), 8);
        ...
        private static GamesNecklace get(@NotNull final Item item) {
        ...
        GamesNecklace(final Item item, final Item result, final int charges) {
            this.item = item;
            this.result = result;
    ...
    private static final class NecklaceTeleport implements Teleport {
        ...
        public void onArrival(final Player player) {
            ...
            final String message = charges == 1 ? "<col=7F00FF>Your games necklace crumbles to dust.</col>" : charges == 2 ? "<col=7F00FF>Your games necklace has one charge left..</col>" : "<col=7F00FF>Your games necklace has " + Utils.format(charges - 1) + " charges left.</col>";
