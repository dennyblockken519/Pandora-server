...
public class SlayerRingItem extends ItemPlugin {
    ...
    private enum SlayerRing {
        ONE(new Item(11873), new Item(ItemId.ENCHANTED_GEM), 1),
        TWO(new Item(11872), new Item(11873), 2),
        THREE(new Item(11871), new Item(11872), 3),
        FOUR(new Item(11870), new Item(11871), 4),
        FIVE(new Item(11869), new Item(11870), 5),
        SIX(new Item(11868), new Item(11869), 6),
        SEVEN(new Item(11867), new Item(11868), 7),
        EIGHT(new Item(11866), new Item(11867), 8),
        ETERNAL(new Item(21268), null, -1);
        ...
        @NotNull
        private static SlayerRing get(@NotNull final Item item) {
        ...
        SlayerRing(final Item item, final Item result, final int charges) {
            this.item = item;
            this.result = result;
    ...
    private static final class RingTeleport implements Teleport {
        ...
        public void onArrival(final Player player) {
            ...
            final String message = charges == 1 ? "<col=7F00FF>Your slayer ring crumbles to dust.</col>" : charges == 2 ? "<col=7F00FF>Your slayer ring has one charge left..</col>" : ring == SlayerRing.ETERNAL ? "<col=7F00FF>No charges were used since the ring holds unlimited charges." : "<col=7F00FF>Your slayer ring has " + Utils.format(charges - 1) + " charges left.</col>";
