...
public class TomeOfFire extends ItemPlugin implements PairedItemOnItemPlugin {
    ...
    @Override
    public void handle() {
        bind("Add or Remove pages", (player, item, container, slotId) -> handleAction(player, item, slotId, "Add or Remove pages", container));
        bind("Add pages", (player, item, container, slotId) -> handleAction(player, item, slotId, "Add pages", container));
        bind("Add pages", (player, item, container, slotId) -> TomeOfFire.handleAction(player, item, slotId, "Add pages", container));
        bind("Add or remove pages", (player, item, container, slotId) -> TomeOfFire.handleAction(player, item, slotId, "Add or remove pages", container));
    }
