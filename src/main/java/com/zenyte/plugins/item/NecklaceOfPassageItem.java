...
public class NecklaceOfPassageItem extends ItemPlugin {
    ...
    private enum NecklaceOfPassage {
        ONE(new Item(21155), null, 1),
        TWO(new Item(21153), new Item(21155), 2),
        THREE(new Item(21151), new Item(21153), 3),
        FOUR(new Item(21149), new Item(21151), 4),
        FIVE(new Item(21146), new Item(21149), 5);
        ...
        @NotNull
        private static NecklaceOfPassage get(@NotNull final Item item) {
        ...
        NecklaceOfPassage(final Item item, final Item result, final int charges) {
            this.item = item;
            this.result = result;
    ...
    private static final class NecklaceTeleport implements Teleport {
        ...
        public void onArrival(final Player player) {
            ...
            final String message = charges == 1 ? "<col=7F00FF>Your necklace of passage crumbles to dust.</col>" : charges == 2 ? "<col=7F00FF>Your necklace of passage has one use left.</col>" : "<col=7F00FF>Your necklace of passage has " + Utils.format(charges - 1) + " uses left.</col>";
