...
public final class FountainOfRunePlugin implements ItemOnObjectAction {
    ...
    private static final int BASIC_CHARGED_GLORY = 11978;
    private static final int TRIMMED_CHARGED_GLORY = 11964;
    private static final int BASIC_CHARGED_ROW = 11980;
    private static final int TRIMMED_CHARGED_ROW = 20786;
    private static final int CHARGED_SKILLS_NECKLACE = 11968;
    private static final int CHARGED_COMBAT_BRACELET = 11972;
    private static final int ETERNAL_GLORY = 19707;
    private static final int[] BASIC_GLORIES = new int[]{1704, 1706, 1708, 1710, 1712, 11976};
    private static final int[] TRIMMED_GLORIES = new int[]{10362, 10360, 10358, 10356, 10354, 11966};
    private static final int[] SKILLS_NECKLACES = new int[]{11113, 11111, 11109, 11107, 11105, 11970};
    private static final int[] COMBAT_BRACELETS = new int[]{11126, 11124, 11122, 11120, 11118, 11974};
    private static final int[] RINGS_OF_WEALTH = new int[]{2572, 11988, 11986, 11984, 11982, 11980};
    private static final int[] TRIMMED_RINGS_OF_WEALTH = new int[]{12785, 20790, 20789, 20788, 20787, 20786};
    ...
    public static void initiate(final Set<Player> players) {
        WorldTasksManager.schedule(() -> {
            ...
            for (int i = 0; i < Utils.random(1, 2); i++) {
                for (final Player player : players) {
                    if (count >= 10) /* Cap to a maximum of 10 projectiles per tick. */
                        break;
                    if (Utils.random(2) == 0 && players.size() == 1) continue;
                    ...
                    projectile.setDelay(Utils.random(30)); /* Randomize the delay so the runes come out flowingly and randomly. */
