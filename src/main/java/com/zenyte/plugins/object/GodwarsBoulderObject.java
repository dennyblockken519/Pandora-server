                    ...
                    switch (ticks++) {
                        case 1:
                            ...
                            player.setForceMovement(
                                    new ForceMovement(new Location(2898, 3719, 0), 330, ForceMovement.NORTH));
                            break;
                        case 6:
                ...
                public void run() {
                    switch (ticks++) {
                        case 1:
                            World.sendObjectAnimation(object, new Animation(6985));
                            player.setForceMovement(
                                    new ForceMovement(new Location(2898, 3715, 0), 330, ForceMovement.SOUTH));
                            break;
                        case 6:
                            World.sendObjectAnimation(object, new Animation(6986));
