...
public final class WildernessLeverObject implements ObjectAction {
    ...
    private static final Location HOME_LEVER = new Location(3115, 3508, 0);
    ...
    public void handleObjectAction(final Player player, final WorldObject object, final String name, final int optionId, final String option) {
        switch (object.getId()) {
            ...
            case 9738:
            case 9472:
                new LeverTeleport(option.equals("Edgeville") ? HOME_LEVER : ARDOUGNE_LEVER, object, "... and teleport out of the Wilderness.",
                        null).teleport(player);
                break;
            case 5959:
                new LeverTeleport(MAGE_BANK_INSIDE_LEVER, object, "... and teleport into the mage's cave.",
                        null).teleport(player);
                break;
        }
    }
        ...
        if (player.getBooleanAttribute("lever_warning")) {
            ...
            player.getDialogueManager().start(new Dialogue(player) {
                ...
                public void buildDialogue() {
                    ...
                    options("Are you sure you want to teleport", "Yes.", "Yes, and don't remind me again.", "No.")
                            .onOptionOne(() -> teleport(player, location, object, message))
                            .onOptionTwo(() -> {
    ...
    public Object[] getObjects() {
        return new Object[]{1815, 9738, 9472, 1814, 5959, 5960, 26761};
    }
