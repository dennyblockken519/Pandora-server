...
public class Preset {
    ...
    private Int2ObjectMap<UnmodifiableItem> defineCollection(@NotNull final Container container) {
        final Int2ObjectOpenHashMap<UnmodifiableItem> collection = new Int2ObjectOpenHashMap<>();
    ...
    public void load(@NotNull final Player player) {
        ...
        final PresetLoadResponse runePouchResponse = loadRunePouch(player, this.runePouch != null && player.getInventory().containsItem(ItemId.RUNE_POUCH));
    ...
    public void setSpellbook(@Nullable final Spellbook spellbook) {
