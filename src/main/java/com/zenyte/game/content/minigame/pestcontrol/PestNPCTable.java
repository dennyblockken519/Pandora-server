...
public enum PestNPCTable {
     ...
     */
    public static final PestNPCTable[] VALUES = new PestNPCTable[]{TORCHER, TORCHER, DEFILER, DEFILER, SHIFTER, SHIFTER, SPLATTER, RAVAGER, SPINNER, BRAWLER};
    private final Class<? extends PestNPC> npcClass;
    private final int[] noviceIds;
    private final int[] intermediateIds;
    private final int[] veteranIds;
    ...
    public int[] getNoviceIds() {
        return this.noviceIds;
    }

    public int[] getIntermediateIds() {
        return this.intermediateIds;
    }

    public int[] getVeteranIds() {
        return this.veteranIds;
    }
}
