    ...
    public void handle() {
        bind("Talk-to", (player, npc) -> player.getDialogueManager().start(new Dialogue(player, npc) {
            ...
            public void buildDialogue() {
                ...
                npc("Ahh, the shot put is a great test of strength and can be "
                        + "quite rewarding. Mind you do it properly though, you "
                        + "might want to dust your hands with some powdery "
                        + "substance first. It'll give you better grip.");
                player("I'll remember that. What should I use?");
                npc("I personally prefer ground ashes, it makes a nice fine "
                        + "powder and gives some really good grip.");
                player("Ok, what else?");
                npc("Basically you'll need to go in there, make sure you've "
                ...
                npc("Maybe, maybe not, but I still had to beat a Barbarian to get it. "
                        + "Mind you, usually they don't part with them. This was an "
                        + "unusual circumstance.");
                player("Oh?");
                npc("I bet him he couldn't catch a squirrel whilst still holding "
                        + "his axe but that I could... and that if I won I'd get his axe.");
                player("What happened?");
                npc("He went running after the squirrel... nearly caught it too... "
                        + "it shot up a tree and he tried to climb up it, only got "
                        + "a bit tangled up with his axe cause he couldn't hand on to it "
                        + "at the same time... he fell out of the tree and it");
                npc("was my turn....");
                npc("I simply went and chopped the tree down with this big old axe, "
                        + "still holding it. The squirrel was so petrified it "
                ...
                npc("Aye indeed. Brawn isn't all you need to wield a big axe, "
                ...
                if (player.getNumericAttribute("warriorsGuildTokens").intValue() > 0) {
                    ...
                    npc("I'm afraid you have not earned any tokens yet. Try "
