...
public final class DummyRoom extends WarriorsGuildArea implements CycleProcessPlugin {
    ...
    private static final WorldObject[] DUMMIES = new WorldObject[]{
            new WorldObject(23958, 10, 0, new Location(2856, 3554, 0)),
            new WorldObject(23959, 10, 0, new Location(2858, 3554, 0)),
            new WorldObject(23960, 10, 1, new Location(2860, 3553, 0)),
            new WorldObject(23961, 10, 1, new Location(2860, 3551, 0)),
            new WorldObject(23962, 10, 2, new Location(2859, 3549, 0)),
            new WorldObject(23963, 10, 2, new Location(2857, 3549, 0)),
            new WorldObject(23964, 10, 3, new Location(2855, 3550, 0))
    };
    private static final WorldObject[] HOLES = new WorldObject[]{
            new WorldObject(23965, 10, 0, new Location(2856, 3554, 0)),
            new WorldObject(24297, 10, 0, new Location(2858, 3554, 0)),
            new WorldObject(24298, 10, 1, new Location(2860, 3553, 0)),
            new WorldObject(24299, 10, 1, new Location(2860, 3551, 0)),
            new WorldObject(24300, 10, 2, new Location(2859, 3549, 0)),
            new WorldObject(24301, 10, 2, new Location(2857, 3549, 0)),
            new WorldObject(24302, 10, 3, new Location(2855, 3550, 0))
    };
