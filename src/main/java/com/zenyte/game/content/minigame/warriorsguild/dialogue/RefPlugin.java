    ...
    public void handle() {
        bind("Talk-to", (player, npc) -> player.getDialogueManager().start(new Dialogue(player, npc) {
            ...
            public void buildDialogue() {
                ...
                player("Shot?");
                npc("Yes Sir. Shot. The iron spheres that are propelled by "
                        + "the chemical energy stored in your body.");
                player("The... what?");
                npc("Your strength Sir. The stronger you are, the further "
                ...
                npc("Sir, the style in which you throw the shot, not the style "
                        + "of the iron.");
                player("Oh! You mean the spinny round thing or the chuck it straight?");
                npc("Crudely put Sir, but yes. Some are more difficult than others. "
                ...
                npc("Sir may find that a fine powder applied to the hands "
                        + "may give one an advantage when putting the shot.");
                player("You mean if I grind something up and put dust on my hands, "
                        + "I'll chuck the ball further?");
                npc("Yes Sir.");
                player("Thanks!");
                npc("You are welcome Sir.");
                player(70, "Bye!");
