 ...
 */
public class Inferno extends DynamicArea implements CycleProcessPlugin, LogoutPlugin, DeathPlugin, CannonRestrictionPlugin, TeleportPlugin, DropPlugin {
    ...
    public void constructed() {
        ...
        if (!resuming) {
            ...
            if (wave > 0) {
                ...
                this.wave = InfernoWave.get(wave);
    ...
    public void leave(final boolean completed) {
        ...
        player.setProtectionDelay(Utils.currentTimeMillis() + TimeUnit.TICKS.toMillis(15));
        if (completed) {
            if (!practiceMode) {
    ...
    public void setNibblerTarget() {
        final ArrayList<RockySupport> supports = new ArrayList<>(3);
    ...
    public void setWave(final InfernoWave wave) {
        this.wave = wave;
    }
    ...
    public WorldObject[] getWallPatches() {
        return this.wallPatches;
    }

    public Location[] getTripleJadSpawnLocations() {
        return this.tripleJadSpawnLocations;
    }
    ...
    public Location[] getRevivalLocations() {
        return this.revivalLocations;
    }

    public Location[] getDragBlockTiles() {
        return this.dragBlockTiles;
    }

    public List<RockySupport> getRockySupports() {
        return this.rockySupports;
    }
    ...
    public Location getSingleJadSpawnLocation() {
        return this.singleJadSpawnLocation;
    }
    ...
    public void setOnAssignment(final boolean onAssignment) {
    ...
    public int getMinShieldY() {
        return this.minShieldY;
    }

    public int getMaxShieldY() {
        return this.maxShieldY;
    }
}
