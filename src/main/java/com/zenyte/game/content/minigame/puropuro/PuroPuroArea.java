...
/**
 * @author Tommeh | 2-11-2018 | 19:19
 * @author Corey 26/01/20
 */
public class PuroPuroArea extends Area implements CycleProcessPlugin, LoginPlugin {
    ...
    public PuroPuroArea() {
        ...
        spawns.forEach(s -> new ImplingNPC(s.getImpling().getNpcId(), s.getLocation(), Direction.SOUTH, 0).setPuroSpawn(true).setInvisibleSpawn(Utils.random(10) < 3).spawn());
    ...
    public static void spawnRareImpling(final Location location) {
        new ImplingNPC(rareImplingTable.rollInt(), location, Direction.SOUTH, 0).setInvisibleSpawn(true).setPuroSpawn(true).setRarePuroSpawn(true).spawn();
    }
    ...
    private static class PuroPuroImplingSpawn {
        ...
        public PuroPuroImplingSpawn(final Location location, final Impling impling) {
        ...
        public boolean equals(@Nullable final Object o) {
            ...
            if (!(o instanceof PuroPuroImplingSpawn other)) return false;
            ...
            return Objects.equals(this$impling, other$impling);
        }
    ...
    public static class MagicalWheatSpawn {
        ...
        public MagicalWheatSpawn(final Location first, final Location second, final boolean perpendicular) {
            this.first = first;
            this.second = second;
        ...
        public void spawn() {
            ...
            WorldTasksManager.schedule(() -> {
                ...
                spawnCooldown = false;
            }, (int) TimeUnit.MILLISECONDS.toTicks(growingWheatAnimation.getCeiledDuration()));
        }
        ...
        public void despawn() {
            ...
            WorldTasksManager.schedule(() -> {
                ...
                spawnCooldown = false;
            }, (int) TimeUnit.MILLISECONDS.toTicks(wiltingWheatAnimation.getCeiledDuration()) + 1);
        }
        ...
        public void setSpawnCooldown(final boolean spawnCooldown) {
        ...
        public boolean equals(@Nullable final Object o) {
            if (o == this) return true;
            if (!(o instanceof MagicalWheatSpawn other)) return false;
            if (!other.canEqual(this)) return false;
