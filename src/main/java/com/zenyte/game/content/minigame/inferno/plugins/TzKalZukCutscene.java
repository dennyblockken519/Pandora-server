...
public class TzKalZukCutscene extends Cutscene {
    ...
    public void build() {
        addActions(0, () -> {
            ...
            player.getDialogueManager().start(new NPCChat(player, 7690, "Oh no! TzKal-Zuk's prison is breaking down. This not meant to have happened. There's nothing I can do for you now JalYt!", false));
        });
