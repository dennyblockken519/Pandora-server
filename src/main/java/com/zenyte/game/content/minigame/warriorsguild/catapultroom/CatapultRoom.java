...
public final class CatapultRoom extends WarriorsGuildArea implements FullMovementPlugin, CycleProcessPlugin {
     ...
     */
    public static void wieldShield(final Player player) {
    ...
    private static OptionalInt findShield(@NotNull final Player player) {
     ...
     */
    private void unequipShield(final Player player) {
        final Appearance appearance = player.getAppearance();
    ...
    private void checkStance(final Player player) {
                        ...
                        if (!p.getAppearance().getForcedAppearance().isEmpty()) checkStance(p);
                            ...
                            p.getDialogueManager().start(new Dialogue(p, 2459) {
                                ...
                                public void buildDialogue() {
                                    ...
                                    npc("Watch out! You'll need to equip the shield as soon as you're on the target spot else you could get hit! Speak to me to get one, and make sure both your hands are free to equip it.");
                                }
                            });
                        }
                    }
