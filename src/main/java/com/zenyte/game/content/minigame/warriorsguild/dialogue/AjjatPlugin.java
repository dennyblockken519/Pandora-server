    ...
    public void handle() {
        bind("Talk-to", (player, npc) -> player.getDialogueManager().start(new Dialogue(player, npc) {
            ...
            public void buildDialogue() {
                npc("Greetings, fellow warrior. I am Ajjat, former black "
                ...
                npc("Indeed I was, however their... methods... did not match "
                        + "with my ideals.. so I left. Harrallak, recognising my "
                        + "talent as a warrior, took me in and offered me a job here.");
                player("Hmm... well if Harrallak trusts you, I guess I can.");
                player(30, "What's the Dummy Room all about?");
                npc("Ahh yes, the dummies. Another ingenious invention of the "
                        + "noble Dwarf Gamfred. They're mechanical you see and pop "
                        + "out of the floor. You have to hit them with the correct "
                        + "attack mode before they disappear again.");
                player("So how do I tell which one is which?");
                npc("There are two different ways. One indication is their "
                        + "colour, the other is the pose and the weapons they are "
                        + "holding, for instance, the one holding daggers you will "
                        + "need to hit with a piercing attack.");
                npc("In the room you will find a poster on the wall which can help "
                        + "you recognise each different dummy.");
                player("That sounds ingenious!");
                npc("Indeed. You may find that you need several weapons to "
                        + "be successful 100% of the time, but keep trying. The "
                ...
                if (player.getNumericAttribute("warriorsGuildTokens").intValue() > 0) {
                    ...
                    npc("I'm afraid you have not earned any tokens yet. Try some "
                            + "of the activities around the guild to earn some.");
