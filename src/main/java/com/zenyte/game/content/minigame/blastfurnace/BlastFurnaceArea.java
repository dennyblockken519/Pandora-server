 ...
 */
public class BlastFurnaceArea extends Area implements CannonRestrictionPlugin, LayableTrapRestrictionPlugin, CycleProcessPlugin {
    /* Object animations */
    ...
    public void process() {
        ...
        for (final Player player : getPlayers()) {
            ...
            final int removalAmt = player.getSkills().getLevel(Skills.SMITHING) >= 60 ? 12 : 15;
