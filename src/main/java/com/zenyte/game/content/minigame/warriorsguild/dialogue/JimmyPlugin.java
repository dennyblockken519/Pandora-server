        ...
        bind("Talk-to", (player, npc) -> {
            player.getDialogueManager().start(new Dialogue(player, npc) {
                ...
                public void buildDialogue() {
                    ...
                    npc("That'sh what I shaid! *HIC* A shtore room.... Now "
                    ...
                    npc("Yer very very shtrange. But.... you pick the keg up, "
                    ...
                    npc("Well... err.. ish not offishal or anyfin... but I got the "
                            + "ledger of tokensh 'ere. I'll jus' err write it in!");
                    player("Won't they know?");
                    npc("Nah... hic.... I'm a wizsh at copyin' signaturesh! Jus' "
                            + "ashk an offishal mem'er of shtaff like Shloane fer yer "
                            + "tokensh.");
                    plain("The rather drunk Jimmy scribbles the tokens you've earned from "
                            + "KegAle Balancing in the Ledger so that you can claim them from an "
