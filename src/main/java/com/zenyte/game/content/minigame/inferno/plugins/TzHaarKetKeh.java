    ...
    private static void practiceMode(final Player player, final NPC npc) {
        player.getDialogueManager().start(new Dialogue(player, npc) {
            ...
            public void buildDialogue() {
                ...
                npc("You can start the Inferno at any wave you wish at a cost of " + Utils.format(practiceFee.getAmount()) + " coins. The fee will be taken from your " + feeLocation + ".");
                npc("Would you like to continue? The fee will be taken off your " + feeLocation + ".");
                options("Continue with the Inferno Practice Mode (costs " + Utils.format(practiceFee.getAmount()) + " coins).", "Yes - continue.", "No.").onOptionOne(() -> setKey(10)).onOptionTwo(() -> setKey(20));
                    ...
                    if (player.getInventory().containsItem(TzHaar.FIRE_CAPE_ITEM)) {
                        ...
                        item(HAND_OVER_CAPE, TzHaar.FIRE_CAPE_ITEM, "You hand your cape to TzHaar-Ket-Keh.").executeAction(() -> {
                            if (player.getInventory().containsItem(TzHaar.FIRE_CAPE_ITEM)) {
                                ...
                                VarCollection.TZHAAR_UNLOCKS.update(player);
                            }
                        });
