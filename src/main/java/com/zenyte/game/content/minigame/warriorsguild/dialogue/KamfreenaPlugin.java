        ...
        bind("Talk-to", (player, npc) -> {
            ...
            player.getDialogueManager().start(new Dialogue(player, npc) {
                ...
                public void buildDialogue() {
                    npc("Why hello there! I'm Kamfreena. Like the look of my "
                            + "pets? I think they're eyeing you up.");
                    player("That was a really bad pun.");
                    npc("Sorry... I don't get to see the rest of the guild much, "
                            + "stuck up here. The Cyclopes don't talk much you see.");
                    player("Shouldn't that be cyclopses?");
                    npc("Nope! Cyclopes is the plural of cyclops. One cyclops, "
                            + "many cyclopes.");
                    ...
                    npc("Ahhh.. our guildmaster, Harrallak, went on an expedition "
                            + "there. He brought them back with him.");
                    options();
                    player(50, "Why are they here?");
                    npc("For the warriors to train on of course! They also drop "
                            + "a rather nice blade.");
                    player("Oh? What would that be?");
                    npc("Defenders.");
                    player("Err what are they?");
                    npc("It's a blade you can defend with using your shield hand, "
                            + "like I have.");
                    player("Wow!");
                    npc("For every 10 tokens you collect around the guild, you can "
                            + "spend one minute in with my pets. As you get defenders "
                            + "you can show them to me to earn even better ones... "
                            + "but remember if you lose them you'll have");
