    ...
    public void handle() {
        bind("Talk-to", (player, npc) -> player.getDialogueManager().start(new Dialogue(player, npc) {
            ...
            public void buildDialogue() {
                npc("Ello there. I'm Gamfred, the engineer in this here guild. "
                ...
                options(TITLE,
                        ...
                        .onOptionOne(() -> setKey(130))
                        .onOptionTwo(() -> setKey(140))
                        .onOptionThree(() -> setKey(150))
                        .onOptionFour(() -> setKey(160));
                player(100, "Bye");
                ...
                npc("Well I guess not everyone will like it. But give it another "
                ...
                npc("Well ye take the big defence shield in both hands and "
                        + "watch the catapult. My assistant will fire different things "
                        + "at you and you need to defend against them.");
                options(TITLE,
                        "May I have a shield please?",
                        "Sounds boring.")
                        .onOptionOne(() -> setKey(161))
                        .onOptionTwo(() -> setKey(210));
                player(210, "Sounds boring.");
                npc("Your loss...");
                player(50, "No, where is it?");
                npc("Are ye blind lad? Tis over there in the next room with "
