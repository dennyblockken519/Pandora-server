...
public enum BroadcastedTreasure {
    ...
    private static final Int2ObjectMap<BroadcastedTreasure> map = Int2ObjectMaps.unmodifiable((Int2ObjectMap<BroadcastedTreasure>) Utils.populateMap(values(), new Int2ObjectOpenHashMap<>(), BroadcastedTreasure::getId));
    private final int id;

    BroadcastedTreasure(final int id) {
        this.id = id;
    }
