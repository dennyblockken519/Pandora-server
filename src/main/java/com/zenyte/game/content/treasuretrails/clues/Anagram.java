...
public enum Anagram implements Clue {
    ...
    A_FATHER_AERECK("Area Chef Trek", MEDIUM, FATHER_AERECK, 921),
    A_BRIMSTAIL("Bail Trims", MEDIUM, 4913, 4914),
    ...
    A_BRUNDT_THE_CHIEFTAIN("Dt Run B", MEDIUM, BRUNDT_THE_CHIEFTAIN, 3926, 8048, 8145, 8153, 8161, 8169),
    A_DUGOPUL("Duo Plug", MASTER, LIGHT_BOX, 5245),
    A_LOWE("El Ow", MEDIUM, 536),
    ...
    A_KARIM("R Ak Mi", MEDIUM, KARIM, 529),
    //A_MARTIN_THWAIT("Rat Mat Within", HARD, MARTIN_THWAIT, 3193),
    A_TRADER_STAN("Red Art Tans", HARD, PUZZLE_BOX, 1328),
    ...
    A_HANS("Snah", MEDIUM, 3077, 6784, 7979),
    ...
    A_HICKTON("Thickno", MEDIUM, HICKTON, 1044),
    ...
    A_YSGAWYN("YAWNS GY", MASTER, LIGHT_BOX, 5298),
    AN_EARL("An Earl", BEGINNER, 530),
    CARPET_AHOY("Carpet Ahoy", BEGINNER, 5036),
    DISORDER("Disorder", BEGINNER, 5034),
    I_CORD("I Cord", BEGINNER, 3893),
    IN_BAR("In Bar", BEGINNER, 1028),
    ...
    Anagram(final String anagram, final ClueLevel level, final int... npcIds) {
        this(anagram, level, null, null, npcIds);
    }

    Anagram(final String anagram, final ClueLevel level, final PuzzleType puzzleType, final int... npcIds) {
        this(anagram, level, null, puzzleType, npcIds);
    }

    Anagram(final String anagram, final ClueLevel level, final ChallengeScroll challenge, final int... npcIds) {
        this(anagram, level, challenge, null, npcIds);
    }

    Anagram(final String anagram, final ClueLevel level, final ChallengeScroll challenge, final PuzzleType puzzleType, final int... npcIds) {
