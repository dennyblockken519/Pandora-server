...
public enum CipherClue implements Clue {
    ...
    GUHCHO(MEDIUM, ChallengeScroll.DREZEL, 3488, 3489),
    ...
    UZZU_MUJHRKYYKJ(HARD, ChallengeScroll.OTTO_GODBLESSED, 2914, 2915),
    VTYR_APCNTGLW(HARD, ChallengeScroll.KING_PERCIVAL, 4058),
    ZCZL(MEDIUM, ChallengeScroll.ADAM, 311),
