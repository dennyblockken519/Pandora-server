...
public final class IceDemonRoom extends RaidArea {
    ...
    public void loadRoom() {
        ...
        final int count = Math.min(raid.getOriginalPlayers().size(), 4);
    ...
    public static final class Brazier extends WorldObject {
         ...
         */
        public void process() {
            final int amount = Math.min(room.getRaid().getOriginalPlayers().size(), kindling);
            kindling -= amount;
        ...
        public boolean equals(@Nullable final Object o) {
            ...
            if (!(o instanceof Brazier other)) return false;
            ...
            if (!Objects.equals(this$icefiend, other$icefiend)) return false;
        ...
        public void setKindling(final int kindling) {
            this.kindling = kindling;
        }
    }
}
