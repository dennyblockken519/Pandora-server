...
public final class Raid {
    ...
    public static void applyPotionEffect(@NotNull final Player player, @NotNull final GourdPotion potion, @NotNull final Item item) {
    ...
    private void informLayout(@NotNull final Player player) {
        ...
        final String filteredLayout = layout.split(" - ")[0].replaceAll("[^FSCP]", Strings.EMPTY);
    ...
    public void setStage(final int stage) {
        ...
        final String duration = Colour.RED.wrap(hours == 0 ? String.format("%02d:%02d", minutes, seconds) : String.format("%02d:%02d:%02d", hours, minutes, seconds));
