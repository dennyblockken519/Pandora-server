...
public final class EnergyFocus extends NPC {
    ...
    private static final Location[][] crystalTiles = new Location[][]{new Location[]{new Location(3283, 5361, 2), new Location(3279, 5366, 2), new Location(3282, 5369, 2), new Location(3287, 5366, 2)}, new Location[]{new Location(3311, 5356, 2), new Location(3320, 5360, 2), new Location(3306, 5361, 2), new Location(3305, 5356, 2)}, new Location[]{new Location(3341, 5355, 2), new Location(3337, 5354, 2), new Location(3340, 5363, 2), new Location(3340, 5367, 2)}};
    ...
    private boolean checkPlayers(final Location tile) {
        for (final Player player : room.getRaid().getPlayers()) {
