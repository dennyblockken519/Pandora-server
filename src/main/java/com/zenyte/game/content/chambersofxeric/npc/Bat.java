...
public class Bat extends RaidNPC<ResourcesRoom> {
    ...
    public enum BatType {
        ...
        BatType(final int id, final int itemId, final int level, final int experience) {
            this.id = id;
            this.itemId = itemId;
            this.level = level;
    ...
    public static final class BatPlugin extends NPCPlugin {
                ...
                public void handle(final Player player, final NPC npc) {
                    player.getActionManager().setAction(new Action() {
                        ...
                        private boolean success(@NotNull final Player player) {
                            final int level = player.getSkills().getLevel(Skills.HUNTER);
        ...
        @Override
        public int[] getNPCs() {
            return new int[]{7587, 7588, 7589, 7590, 7591, 7592, 7593};
        }
    }
}
