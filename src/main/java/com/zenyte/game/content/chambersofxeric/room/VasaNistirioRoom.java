...
public final class VasaNistirioRoom extends RaidArea {
     ...
     */
    private static final Location[][] crystalLocations = new Location[][]{new Location[]{new Location(3270, 5285, 0), new Location(3270, 5303, 0), new Location(3287, 5303, 0), new Location(3287, 5285, 0)}, new Location[]{new Location(3301, 5285, 0), new Location(3301, 5302, 0), new Location(3319, 5302, 0), new Location(3319, 5285, 0)}, new Location[]{new Location(3333, 5285, 0), new Location(3333, 5303, 0), new Location(3350, 5303, 0), new Location(3350, 5285, 0)}};
    /**
     ...
     */
    private static final Location[][] blockingCrystalLocations = new Location[][]{new Location[]{new Location(3268, 5295, 0), new Location(3268, 5296, 0)}, new Location[]{new Location(3311, 5307, 0), new Location(3312, 5307, 0)}, new Location[]{new Location(3355, 5296, 0), new Location(3355, 5295, 0)}};
    /**
     * An array containing coordinates to the fire blocking the entrance.
     */
    private static final Location[] fireLocations = new Location[]{new Location(3279, 5281, 0), new Location(3311, 5281, 0), new Location(3343, 5281, 0)};
    /**
     * An array of coordinates defining the center of the room, considering vasa's large size.
     */
    private static final Location[] npcCenterLocations = new Location[]{new Location(3278, 5293, 0), new Location(3309, 5293, 0), new Location(3341, 5294, 0)};
    /**
     * An array of coordinates defining the center of the room.
     */
    private static final Location[] absoluteCenterLocations = new Location[]{new Location(3280, 5296, 0), new Location(3312, 5296, 0), new Location(3344, 5296, 0)};
    /**
    ...
    public VasaNistirioRoom(final RaidRoom type, final Raid raid, final int rotation, final int size, final int regionX, final int regionY, final int chunkX, final int chunkY, final int fromPlane, final int toPlane) {
