...
public final class Tekton extends RaidNPC<TektonRoom> {
    ...
    public Direction faceLocation(final Location location) {
        ...
        final int direction = Utils.getFaceDirection(location.getX() - middle.getX(), location.getY() - middle.getY());
    ...
    public int getEnrageTime() {
        return this.enrageTime;
    }

    public void setEnrageTime(final int enrageTime) {
    ...
    public void setBlock(final WorldObject block) {
        this.block = block;
    }
    ...
    public void setEnteredCombat(final boolean enteredCombat) {
    ...
    public void setBoostedStats(final boolean boostedStats) {
