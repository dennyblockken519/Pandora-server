...
public final class Magic {
    ...
    public static Optional<CombatSpell> getCombatSpell(@NotNull final Spellbook spellbook, @NotNull final String name) {
    ...
    public static void add(final Class<? extends MagicSpell> c) {
        try {
            ...
            final MagicSpell spell = c.newInstance();
            final Spellbook spellbook = spell.getSpellbook();
            spellbook.getSpellCollection().put(spell.getSpellName(), spell);
    ...
    public static <T extends MagicSpell> T getSpell(@NotNull final Spellbook spellbook, final String name, @NotNull final Class<T> type) {
        final MagicSpell spell = spellbook.getSpellCollection().get(name);
