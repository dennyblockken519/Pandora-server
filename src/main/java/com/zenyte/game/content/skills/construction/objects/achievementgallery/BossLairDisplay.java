...
public final class BossLairDisplay implements ObjectInteraction, ItemOnObjectAction {
    ...
    public Object[] getObjects() {
        return new Object[]{29157, 29158, 29159, 29160, 29161, 29162, 29163, 31689, 31978};
    }
    ...
    private static final class ConfigurationD extends Dialogue {
        ...
        public static final ImmutableMap<Integer, Integer> MAP = ImmutableMap.<Integer, Integer>
                        builder().put(12007, 0).put(12885, 1).put(12936, 2).put(13245, 3)
                .put(13277, 4).put(19701, 5).put(21745, 6).put(22106, 7).build();
        ...
        public void buildDialogue() {
            options("Select a jar to display.",
                    jars.contains(12007) ? "Jar of dirt." : "<str>Jar of dirt.",
                    jars.contains(12885) ? "Jar of sand." : "<str>Jar of sand.",
                    jars.contains(12936) ? "Jar of swamp." : "<str>Jar of swamp.",
                    jars.contains(13245) ? "Jar of souls." : "<str>Jar of souls.",
                    "Next selection.")
                    .onOptionOne(() -> {
                        handleJar(12007);
                        finish();
            ...
            options(5, "Select a jar to display.",
                    jars.contains(13277) ? "Jar of miasma." : "<str>Jar of miasma.",
                    jars.contains(19701) ? "Jar of darkness." : "<str>Jar of darkness.",
                    jars.contains(21745) ? "Jar of stone." : "<str>Jar of stone.",
                    jars.contains(22106) ? "Jar of decay." : "<str>Jar of decay.",
                    "Previous selection.")
                    .onOptionOne(() -> {
                        handleJar(13277);
                        finish();
    ...
    private static final class JarDialogue extends Dialogue {
        ...
        private static final ImmutableMap<Integer, Integer> MAP = ImmutableMap.<Integer, Integer>
                        builder().put(12007, 29158).put(12936, 29159).put(12885, 29160).put(13245, 29161)
                .put(13277, 29162).put(19701, 29163).put(21745, 31689).put(22106, 31978).build();
        private final RoomReference reference;
