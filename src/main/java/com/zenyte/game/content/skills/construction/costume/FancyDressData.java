...
public enum FancyDressData {
    ...
    public static final Map<Integer, FancyDressData> MAP = new HashMap<>(VALUES.length * 5);
    public static final Map<Integer, FancyDressData> DISPLAY_MAP = new HashMap<>(VALUES.length);
