...
public enum ArmourData {
    ...
    public static final ItemContainer[] CONTAINERS = new ItemContainer[]{new ItemContainer(40, false), new ItemContainer(3, false)};
    public static final Map<Integer, ArmourData> MAP = new HashMap<>(VALUES.length * 5);
    public static final Map<Integer, ArmourData> DISPLAY_MAP = new HashMap<>(VALUES.length);

    static {
        for (int i = 0; i <= ANCESTRAL_ROBES.ordinal(); i++) CONTAINERS[0].add(new Item(VALUES[i].displayItem));
