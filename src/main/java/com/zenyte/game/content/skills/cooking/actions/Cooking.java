...
public class Cooking extends Action {
    ...
    public int processWithDelay() {
        ...
        if (isBurning()) {
            ...
            player.getSkills().addXp(Skills.COOKING, data.getXp());
    ...
    private boolean isBurning() {
        ...
        final int burnChance = burnLevel - (hasGauntlets ? 5 : 0) - (object.getId() == 21302 ? 5 : 0) - player.getSkills().getLevel(Skills.COOKING);
