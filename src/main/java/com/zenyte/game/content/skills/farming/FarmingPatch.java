...
public enum FarmingPatch {
    FALADOR_ALLOTMENT_NW(PatchType.ALLOTMENT, 8550, new Location(3052, 3310, 0), new PatchGardener(2663, 3), "North-Western allotment", 8),
    FALADOR_ALLOTMENT_SE(PatchType.ALLOTMENT, 8551, new Location(3057, 3305, 0), new PatchGardener(2663, 4), "South-Eastern allotment", 9),
    ...
    PHASMATYS_ALLOTMENT_NW(PatchType.ALLOTMENT, 8556, new Location(3599, 3528, 0), new PatchGardener(2666, 3), "North-Western allotment", 14),
    PHASMATYS_ALLOTMENT_SE(PatchType.ALLOTMENT, 8557, new Location(3604, 3523, 0), new PatchGardener(2666, 4), "South-Eastern allotment", 15),
    ...
    CATHERBY_ALLOTMENT_N(PatchType.ALLOTMENT, 8552, new Location(2810, 3466, 0), new PatchGardener(2664, 3), "Northern allotment", 10),
    CATHERBY_ALLOTMENT_S(PatchType.ALLOTMENT, 8553, new Location(2810, 3461, 0), new PatchGardener(2664, 4), "Southern allotment", 11),
    ...
    ARDOUGNE_ALLOTMENT_N(PatchType.ALLOTMENT, 8554, new Location(2667, 3377, 0), new PatchGardener(2665, 3), "Northern allotment", 12),
    ARDOUGNE_ALLOTMENT_S(PatchType.ALLOTMENT, 8555, new Location(2667, 3372, 0), new PatchGardener(2665, 4), "Southern allotment", 13),
    ...
    KOUREND_ALLOTMENT_NE(PatchType.ALLOTMENT, 27113, new Location(1817, 3489, 0), new PatchGardener(6921, 3), "North-Eastern allotment", 51),
    KOUREND_ALLOTMENT_SW(PatchType.ALLOTMENT, 27114, new Location(1812, 3484, 0), new PatchGardener(6921, 4), "South-Western allotment", 52),
    KOUREND_FLOWER(PatchType.FLOWER_PATCH, 27111, new Location(1814, 3486, 0), 53),
    KOUREND_HERB(PatchType.HERB_PATCH, 27115, new Location(1818, 3482, 0), 54),
    ...
    CHAMPIONS_GUILD_BUSH(PatchType.BUSH_PATCH, 7577, new Location(3181, 3357, 0), new PatchGardener(2674, 3), "bush", 20),
    ...
    ETCETERIA_SPIRIT_TREE(PatchType.SPIRIT_TREE_PATCH, 8382, new Location(2612, 3857, 0), new PatchGardener(2685, 3), "spirit tree", 25),
    ...
    GNOME_STRONGHOLD_TREE(PatchType.TREE_PATCH, 19147, new Location(2436, 3415, 0), new PatchGardener(2687, 3), "tree", 4),
    GNOME_STRONGHOLD_FRUIT_TREE(PatchType.FRUIT_TREE_PATCH, 7962, new Location(2475, 3445, 0), new PatchGardener(2682, 3), "fruit tree", 48),
    CATHERBY_FRUIT_TREE(PatchType.FRUIT_TREE_PATCH, 7965, new Location(2860, 3433, 0), new PatchGardener(2670, 3), "fruit tree", 7),
    GNOME_MAZE_FRUIT_TREE(PatchType.FRUIT_TREE_PATCH, 7963, new Location(2489, 3179, 0), new PatchGardener(2683, 3), "fruit tree", 5),
    BRIMHAVEN_FRUIT_TREE(PatchType.FRUIT_TREE_PATCH, 7964, new Location(2764, 3212, 0), new PatchGardener(2669, 3), "fruit tree", 6),
    BRIMHAVEN_SPIRIT_TREE(PatchType.SPIRIT_TREE_PATCH, 8383, new Location(2802, 3203, 0), new PatchGardener(2686, 3), "spirit tree", 26),
    LLETYA_FRUIT_TREE(PatchType.FRUIT_TREE_PATCH, 26579, new Location(2346, 3161, 0), new PatchGardener(2689, 3), "fruit tree", 49),
    PORT_SARIM_SPIRIT_TREE(PatchType.SPIRIT_TREE_PATCH, 8338, new Location(3060, 3258, 0), new PatchGardener(2684, 3), "spirit tree", 24),
    KOUREND_SPIRIT_TREE(PatchType.SPIRIT_TREE_PATCH, 27116, new Location(1693, 3542, 0), new PatchGardener(6814, 3), "spirit tree", 50),
    HARDWOOD_TREE_W(PatchType.HARDWOOD_TREE_PATCH, 30481, new Location(3702, 3837, 0), new PatchGardener(7756, 3), "hardwood tree", 149),
    HARDWOOD_TREE_MID(PatchType.HARDWOOD_TREE_PATCH, 30480, new Location(3708, 3833, 0), new PatchGardener(7755, 3), "hardwood tree", 150),
    HARDWOOD_TREE_E(PatchType.HARDWOOD_TREE_PATCH, 30482, new Location(3715, 3835, 0), new PatchGardener(7754, 3), "hardwood tree", 151),
    ...
    TAI_BWO_WANNAI_CALQUAT(PatchType.CALQUAT_PATCH, 7807, new Location(2796, 3101, 0), new PatchGardener(2688, 3), "calquat", 31),
    ...
    KOUREND_COMPOST(PatchType.COMPOST_BIN, 27112, new Location(1810, 3490, 0), 55),
    FARMING_GUILD_BIG_COMPOST(PatchType.COMPOST_BIN, 34631, new Location(1272, 3730, 0), 68),
    FARMING_GUILD_REDWOOD(PatchType.REDWOOD_PATCH, new int[]{34051, 34052, 34053, 34054, 34055, 34056, 34057, 34058, 34059, 34633, 34635, 34639, 34637}, new Location(1228, 3755, 0), new PatchGardener(8536, 3), "redwood tree", -1),
    FARMING_GUILD_FLOWER(PatchType.FLOWER_PATCH, 33649, new Location(1260, 3725, 0), -1),
    FARMING_GUILD_BUSH(PatchType.BUSH_PATCH, 34006, new Location(1260, 3733, 0), new PatchGardener(8535, 3), "bush patch", -1),
    FARMING_GUILD_SOUTH_ALLOTMENT(PatchType.ALLOTMENT, 33693, new Location(1269, 3726, 0), new PatchGardener(8535, 3), "southern allotment", -1),
    FARMING_GUILD_NORTH_ALLOTMENT(PatchType.ALLOTMENT, 33694, new Location(1269, 3734, 0), new PatchGardener(8535, 3), "northern allotment", -1),
    FARMING_GUILD_CACTUS(PatchType.CACTUS_PATCH, 33761, new Location(1264, 3747, 0), new PatchGardener(8535, 3), "cactus patch", -1),
    FARMING_GUILD_HERB(PatchType.HERB_PATCH, 33979, new Location(1238, 3726, 0), -1),
    FARMING_GUILD_TREE(PatchType.TREE_PATCH, 33732, new Location(1232, 3736, 0), new PatchGardener(8534, 3), "tree", -1),
    FARMING_GUILD_ANIMA(PatchType.ANIMA_PATCH, 33998, new Location(1232, 3723, 0), -1),
    FARMING_GUILD_SPIRIT_TREE(PatchType.SPIRIT_TREE_PATCH, 33733, new Location(1253, 3750, 0), new PatchGardener(8537, 3), "spirit tree", -1),
    FARMING_GUILD_FRUIT_TREE(PatchType.FRUIT_TREE_PATCH, 34007, new Location(1242, 3758, 0), new PatchGardener(8533, 3), "fruit tree", -1),
    FARMING_GUILD_CELASTRUS(PatchType.CELASTRUS_PATCH, 34629, new Location(1244, 3750, 0), new PatchGardener(8629, 3), "celstrus tree", -1),
    ...
    public static final Int2ObjectOpenHashMap<FarmingPatch> PATCHES = new Int2ObjectOpenHashMap<>();
    private static final Int2ObjectOpenHashMap<FarmingPatch> gardeners = new Int2ObjectOpenHashMap<>();
    ...
    FarmingPatch(final PatchType type, final int id, final Location center, final PatchGardener gardener, final String description, final int index) {
        this(type, new int[]{id}, center, gardener, description, index);
    }

    FarmingPatch(final PatchType type, final int[] ids, final Location center, final PatchGardener gardener, final String description, final int index) {
        this.type = type;
        this.ids = ids;
        this.index = index;
    ...
    public static Optional<FarmingPatch> getPatchByGardener(final int id, final int option) {
        final FarmingPatch patch = gardeners.get(id | option << 16);
        return patch == null ? Optional.empty() : Optional.of(patch);
    }

    public static Optional<Set<FarmingPatch>> getPatchSetByGardeners(final int id) {
    ...
    public static Int2ObjectOpenHashMap<Set<FarmingPatch>> getPatchSetByGardeners() {
        return FarmingPatch.patchSetByGardeners;
    }
