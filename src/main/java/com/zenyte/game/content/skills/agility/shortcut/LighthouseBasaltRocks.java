...
public class LighthouseBasaltRocks implements Shortcut {
    ...
    static {
        ...
        //Reverse fill.
        final Object2ObjectOpenHashMap<Location, Location> altMap = new Object2ObjectOpenHashMap<>();
    ...
    public void startSuccess(final Player player, final WorldObject object) {
        ...
        player.setForceMovement(new ForceMovement(player.getLocation(), 15, dest, 35, Utils.getFaceDirection(dest.getX() - player.getX(), dest.getY() - player.getY())));
