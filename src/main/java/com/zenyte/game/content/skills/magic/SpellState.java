...
public final class SpellState {
    ...
    private static final int[] SLAYER_STAVES = new int[]{12902, 21255, 12904, 22296, 4170, 11791};
    private static final int[] SARADOMIN_STAVES = new int[]{2415, 22296};
    private static final int[] GUTHIX_STAVES = new int[]{2416, 8841};
    ...
    private static final RuneResource[] RESOURCES = new RuneResource[]{STAFF_RESOURCE, TOME_RESOURCE, INVENTORY_RESOURCE, RUNE_POUCH_RESOURCE, SECONDARY_RUNE_POUCH_RESOURCE, BRYOPHYTAS_RESOURCE};
    ...
    static {
        ...
        ALT_STAVES = new Int2ObjectOpenHashMap<>(5);
     ...
     * @param amount   the amount of the rune.
     ...
     *
     * @param source the source to check for the given rune.
     * @param id     the id of the rune.
     * @param amount the amount of the rune.
