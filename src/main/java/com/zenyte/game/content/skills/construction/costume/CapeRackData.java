...
public enum CapeRackData {
    ...
    public static final ItemContainer[] CONTAINERS = new ItemContainer[]{new ItemContainer(40, false), new ItemContainer(4, false)};
    public static final Map<Integer, CapeRackData> MAP = new HashMap<>(VALUES.length * 5);
    public static final Map<Integer, CapeRackData> DISPLAY_MAP = new HashMap<>(VALUES.length);
    ...
    static {
        ...
        for (CapeRackData val : VALUES) {
            ...
            } else CONTAINERS[1].add(new Item(val.displayItem));
