...
public final class TeleportFocus implements ObjectInteraction {
    ...
    public void handleObjectAction(Player player, Construction construction, RoomReference reference, WorldObject object, int optionId, String option) {
        final List<String> portals = new ArrayList<>();
        final List<FurnitureData> furnitureList = new ArrayList<>();
    ...
    private void populateLists(final RoomReference reference, final List<String> portals, final List<FurnitureData> furnitureList) {
    ...
    public Object[] getObjects() {
        return new Object[]{13639, 13640, 13641};
    }
