...
public class FletchingDefinitions {
    ...
    public static final Item[][] PRODUCTS = new Item[][]{{new Item(52, 15), new Item(19584, 15), new Item(50), new Item(48), new Item(9440)}, {new Item(52, 30), new Item(54), new Item(56), new Item(9442), new Item(22251)}, {new Item(52, 45), new Item(60), new Item(58), new Item(9444), new Item(22254)}, {new Item(52, 60), new Item(64), new Item(62), new Item(9448), new Item(22257)}, {new Item(9446)}, {new Item(9450)}, {new Item(52, 75), new Item(68), new Item(66), new Item(9452), new Item(22260)}, {new Item(52, 90), new Item(72), new Item(70), new Item(21952), new Item(22263)}, {new Item(52, 105), new Item(22266)}};
    public static final Item[][] MATERIALS = new Item[][]{{new Item(1511), new Item(1511), new Item(1511), new Item(1511), new Item(1511)}, {new Item(1521), new Item(1521), new Item(1521), new Item(1521), new Item(1521, 2)}, {new Item(1519), new Item(1519), new Item(1519), new Item(1519), new Item(1519, 2)}, {new Item(1517), new Item(1517), new Item(1517), new Item(1517), new Item(1517, 2)}, {new Item(6333)}, {new Item(6332)}, {new Item(1515), new Item(1515), new Item(1515), new Item(1515), new Item(1515, 2)}, {new Item(1513), new Item(1513), new Item(1513), new Item(1513), new Item(1513, 2)}, {new Item(19669), new Item(19669, 2)}};
    ...
    public static boolean isMaterial(final Item from, final Item to) {
        for (int i = 0; i < FletchingDefinitions.MATERIALS.length; i++) {
            for (int x = 0; x < FletchingDefinitions.MATERIALS[i].length; x++)
                if ((from.getId() == FletchingDefinitions.MATERIALS[i][x].getId() || to.getId() == FletchingDefinitions.MATERIALS[i][x].getId()) && (from.getId() == FletchingDefinitions.KNIFE.getId() || to.getId() == FletchingDefinitions.KNIFE.getId()))
                    return true;
        }
        return false;
    }
    ...
    public enum BoltTipFletchingData {
        OPAL_BOLT_TIPS(11, 1.6, new Animation(890), new Item(45, 12), new Item(1609)),
        JADE_BOLT_TIPS(26, 2.4, new Animation(891), new Item(9187, 12), new Item(1611)),
        PEARL_BOLT_TIPS(41, 4, new Animation(890), new Item(46, 6), new Item(411)),
        RED_TOPAZ_BOLT_TIPS(48, 4, new Animation(892), new Item(9188, 12), new Item(1613)),
        SAPPHIRE_BOLT_TIPS(56, 4, new Animation(888), new Item(9189, 12), new Item(1607)),
        EMERALD_BOLT_TIPS(58, 5.5, new Animation(889), new Item(9190, 12), new Item(1605)),
        RUBY_BOLT_TIPS(63, 6, new Animation(887), new Item(9191, 12), new Item(1603)),
        DIAMOND_BOLT_TIPS(65, 7.5, new Animation(886), new Item(9192, 12), new Item(1601)),
        DRAGONSTONE_BOLT_TIPS(71, 8.2, new Animation(885), new Item(9193, 12), new Item(1615)),
        ONYX_BOLT_TIPS(73, 33.6, new Animation(2717), new Item(9194, 24), new Item(6573));
        ...
        public static boolean hasRequirements(final Player player, final BoltTipFletchingData data) {
            if (player.getSkills().getLevel(Skills.FLETCHING) < data.getLevel()) {
    ...
    public enum AmmunitionFletchingData {
        ...
        public static boolean setsOf15(final AmmunitionFletchingData data) {
            return data.getType().equals(AmmunitionType.ARROW) || data.getType().equals(AmmunitionType.JAVELIN);
        }
                ...
                for (final Item i : data.getMaterials()) {
                    if (i.getId() == from.getId() || (data == WOLFBONE_TIPS && from.getId() == ItemId.CHISEL && to.getId() != ItemId.CHISEL) || (data == OGRE_ARROW_SHAFT && from.getId() == ItemId.KNIFE && to.getId() != ItemId.KNIFE)) {
                        for (final Item o : data.getMaterials()) {
                            if (o.getId() == to.getId() && (i != o || data == OGRE_ARROW_SHAFT || data == WOLFBONE_TIPS) || (data == WOLFBONE_TIPS && to.getId() == ItemId.CHISEL && from.getId() != ItemId.CHISEL) || (data == OGRE_ARROW_SHAFT && to.getId() == ItemId.KNIFE && from.getId() != ItemId.KNIFE))
                                return data;
                        }
                        continue loop;
                    }
    ...
    public enum BowFletchingData {
        ...
        public static final HashMap<Integer, BowFletchingData> VALUES = new HashMap<>(VALUES_ARR.length);
