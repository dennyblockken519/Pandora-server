...
public final class ServantsMoneybag implements ObjectInteraction, ItemOnObjectAction {
    ...
    public Object[] getObjects() {
        return new Object[]{28859};
    }

    @Override
    public void handleObjectAction(final Player player, final Construction construction, final RoomReference reference, final WorldObject object, final int optionId,
                                   final String option) {
        ...
        player.getDialogueManager()
                .start(new OptionDialogue(player, "Servant's moneybag: " + player.getConstruction().getServantsCash() + " coins.",
                        new String[]{"Withdraw money.", "Add money.", "Nothing."},
                        new Runnable[]{() -> withdraw(player), () -> add(player), null}));
    }
