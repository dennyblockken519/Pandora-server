    ...
    public void handle() {
        bind("Talk-to", (player, npc) -> player.getDialogueManager().start(new Dialogue(player, npc) {
            ...
            public void buildDialogue() {
                final boolean eligible = DiaryReward.MORYTANIA_LEGS1.eligibleFor(player) && DiaryReward.MORYTANIA_LEGS2.eligibleFor(player) && DiaryReward.MORYTANIA_LEGS3.eligibleFor(player);
                if (!eligible) {
