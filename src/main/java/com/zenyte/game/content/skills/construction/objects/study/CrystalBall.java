...
public final class CrystalBall implements ItemOnObjectAction {
    ...
    public Object[] getObjects() {
        return new Object[]{13659, 13660, 13661};
    }
    ...
    private enum Staff {
        ...
        private static final Item[][] STAFF_GROUPS = new Item[][]{
                new Item[]{new Item(1381), new Item(1383), new Item(1385), new Item(1387)},
                new Item[]{new Item(1397), new Item(1395), new Item(1399), new Item(1393)},
                new Item[]{new Item(1405), new Item(1403), new Item(1407), new Item(1401)}
        };
        private static final Staff[] VALUES = values();
        private static final Map<Integer, Staff> MAP = new HashMap<>(VALUES.length);

        static {
            for (Staff value : VALUES)
                MAP.put(value.staffId, value);
        }
