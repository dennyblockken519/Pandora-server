...
public final class TeakShelf implements ObjectInteraction {
    ...
    private static final String[] FIRST_SHELF = new String[]{
            "A bowl.",
            "A pie dish.",
            "An empty pot.",
            "Previous selection."
    ...
    private static final String[] SECOND_SHELF = new String[]{
            "A bowl.",
            "A pie dish.",
            "An empty pot.",
            "A Chef's hat.",
    ...
    public void handleObjectAction(final Player player, final Construction construction, final RoomReference reference, final WorldObject object, final int optionId, final String option) {
        ...
        player.getDialogueManager().start(new Dialogue(player) {
            ...
            public void buildDialogue() {
                options("What would you like to take?",
                        "A kettle.",
                        "A teapot.",
                        "A porcelain cup.",
                        "An empty beer glass.",
                ...
                options(5, "What would you like to take?", id == 13558 ? SECOND_SHELF : FIRST_SHELF)
                        .onOptionOne(() -> {
                            addItem(player, 4, id);
                            finish();
                        })
