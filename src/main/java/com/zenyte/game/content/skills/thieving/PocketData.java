...
public enum PocketData {
    ...
    YANILLE_WATCHMAN(65, 65, 137.5, CoinPouch.WATCHMAN, true, 5, 3, 3, new String[]{"What do you think you're doing?"}, new ImmutableItem[]{new ImmutableItem(CoinPouch.WATCHMAN.getItemId()), new ImmutableItem(2309, 1)}, 3251),
    ...
    HERO(80, 80, 275, CoinPouch.HERO, true, 6, 4, 4, new String[]{"What do you think you're doing?"}, new ImmutableItem[]{new ImmutableItem(CoinPouch.HERO.getItemId()), new ImmutableItem(565), new ImmutableItem(1601), new ImmutableItem(1993), new ImmutableItem(560, 2), new ImmutableItem(569), new ImmutableItem(444)}, 3106),
    ELF(85, 85, 353, CoinPouch.ELF, true, 6, 5, 5, new String[]{"What do you think you're doing?"}, new ImmutableItem[]{new ImmutableItem(CoinPouch.ELF.getItemId()), new ImmutableItem(561, 3), new ImmutableItem(1601), new ImmutableItem(1993), new ImmutableItem(560, 2), new ImmutableItem(569), new ImmutableItem(444)}, "Elf", "Arvel", "Mawrth", "Goreu", "Kelyn", "Ysgawyn"),
