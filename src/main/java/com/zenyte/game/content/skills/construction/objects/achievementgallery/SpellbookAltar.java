...
public final class SpellbookAltar implements ObjectInteraction {
    ...
    public Object[] getObjects() {
        return new Object[]{29147, 29148, 29149, 29150};
    }
    ...
    private static final class VenerateD extends Dialogue {
        ...
        public void buildDialogue() {
            ...
            options("Select a spellbook.",
                    (id == 0 ? "<str>" : "") + "Normal spellbook.",
                    (id == 1 ? "<str>" : "") + "Ancient spellbook.",
                    (id == 2 ? "<str>" : "") + "Lunar spellbook.",
                    (id == 3 ? "<str>" : "") + "Arceuus spellbook.")
                    .onOptionOne(() -> {
                        pray(0);
                        finish();
                    })
        ...
        private void pray(final int id) {
