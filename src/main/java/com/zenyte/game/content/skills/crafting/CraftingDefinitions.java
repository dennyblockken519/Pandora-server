...
public class CraftingDefinitions {
    ...
    public static final Item[][] PRODUCTS = new Item[][]{{new Item(1059), new Item(1061), new Item(1167), new Item(1063), new Item(1129), new Item(1095), new Item(1169)}, {new Item(1131)}, {new Item(1133), new Item(1097)}, {new Item(10077), new Item(10079), new Item(10081), new Item(10083), new Item(10085)}, {new Item(1065), new Item(1099), new Item(1135)}, {new Item(2487), new Item(2493), new Item(2499)}, {new Item(2489), new Item(2495), new Item(2501)}, {new Item(2491), new Item(2497), new Item(2503)}, {new Item(6328), new Item(6330), new Item(6326), new Item(6324), new Item(6322)}, {new Item(10824), new Item(10822)}, {new Item(7539), new Item(7537)}, {new Item(13385), new Item(13389), new Item(13387)}};
    ...
    public enum AmuletStringingData {
        ...
        public static final HashMap<Integer, AmuletStringingData> VALUES = new HashMap<>(VALUES_ARR.length);
    ...
    public enum BattlestaffAttachingData {
        ...
        public static final HashMap<Integer, BattlestaffAttachingData> VALUES = new HashMap<>(VALUES_ARR.length);
    ...
    public enum GemCuttingData {
        ...
        AMETHYST(83, 60, new Animation(6295), new Item(21347), new Item(21338, 15), new Item(21350, 15), new Item(21352, 5)),
        ZENYTE(89, 200, new Animation(7185), new Item(19496), new Item(19493));
        public static final GemCuttingData[] VALUES_ARR = values();
        public static final HashMap<Integer, GemCuttingData> VALUES = new HashMap<>(VALUES_ARR.length);
    ...
    public enum GlassBlowingData {
        ...
        public static final HashMap<Integer, GlassBlowingData> VALUES = new HashMap<>(VALUES_ARR.length);
    ...
    public enum JewelleryData {
        OPAL_RING(1, 10, 4, 0, new Item(21081), new Item(1609), SILVER_BAR),
        OPAL_NECKLACE(16, 35, 4, 3, new Item(21090), new Item(1609), SILVER_BAR),
        OPAL_BRACELET(22, 45, 4, 9, new Item(21117), new Item(1609), SILVER_BAR),
        OPAL_AMULET(27, 55, 4, 6, new Item(21099), new Item(1609), SILVER_BAR),
        JADE_RING(13, 32, 4, 1, new Item(21084), new Item(1611), SILVER_BAR),
        JADE_NECKLACE(25, 54, 4, 4, new Item(21093), new Item(1611), SILVER_BAR),
        JADE_BRACELET(29, 60, 4, 10, new Item(21120), new Item(1611), SILVER_BAR),
        JADE_AMULET(34, 70, 4, 7, new Item(21102), new Item(1611), SILVER_BAR),
        TOPAZ_RING(16, 35, 4, 2, new Item(21087), new Item(1613), SILVER_BAR),
        TOPAZ_NECKLACE(32, 70, 4, 5, new Item(21096), new Item(1613), SILVER_BAR),
        TOPAZ_BRACELET(38, 75, 4, 11, new Item(21123), new Item(1613), SILVER_BAR),
        TOPAZ_AMULET(45, 80, 4, 8, new Item(21105), new Item(1613), SILVER_BAR),
        UNSTRUNG_SYMBOL(16, 50, 6, 0, new Item(1714), SILVER_BAR),
        UNSTRUNG_EMBLEM(17, 50, 6, 1, new Item(1720), SILVER_BAR),
        TIARA(23, 52.5, 6, 5, new Item(5525), SILVER_BAR),
        SILVER_BOLTS(21, 50, 6, 4, new Item(9382, 10), SILVER_BAR),
        GOLD_RING(5, 15, 7, new Item(1635), GOLD_BAR),
        GOLD_NECKLACE(6, 20, 21, new Item(1654), GOLD_BAR),
        GOLD_BRACELET(7, 25, 46, new Item(11069), GOLD_BAR),
        GOLD_AMULET(8, 30, 34, new Item(1673), GOLD_BAR),
        SAPPHIRE_RING(20, 40, 8, new Item(1637), new Item(1607), GOLD_BAR),
        SAPPHIRE_NECKLACE(22, 55, 22, new Item(1656), new Item(1607), GOLD_BAR),
        SAPPHIRE_BRACELET(23, 60, 48, new Item(11071), new Item(1607), GOLD_BAR),
        SAPPHIRE_AMULET(24, 65, 35, new Item(1675), new Item(1607), GOLD_BAR),
        EMERALD_RING(27, 55, 9, new Item(1639), new Item(1605), GOLD_BAR),
        EMERALD_NECKLACE(29, 60, 23, new Item(1658), new Item(1605), GOLD_BAR),
        EMERALD_BRACELET(30, 65, 49, new Item(11076), new Item(1605), GOLD_BAR),
        EMERALD_AMULET(31, 70, 36, new Item(1677), new Item(1605), GOLD_BAR),
        RUBY_RING(34, 70, 10, new Item(1641), new Item(1603), GOLD_BAR),
        RUBY_NECKLACE(40, 75, 24, new Item(1660), new Item(1603), GOLD_BAR),
        RUBY_BRACELET(42, 80, 50, new Item(11085), new Item(1603), GOLD_BAR),
        RUBY_AMULET(50, 85, 37, new Item(1679), new Item(1603), GOLD_BAR),
        DIAMOND_RING(43, 85, 11, new Item(1643), new Item(1601), GOLD_BAR),
        DIAMOND_NECKLACE(56, 90, 25, new Item(1662), new Item(1601), GOLD_BAR),
        DIAMOND_BRACELET(58, 95, 51, new Item(11092), new Item(1601), GOLD_BAR),
        DIAMOND_AMULET(70, 100, 38, new Item(1681), new Item(1601), GOLD_BAR),
        DRAGONSTONE_RING(55, 100, 12, new Item(1645), new Item(1615), GOLD_BAR),
        DRAGONSTONE_NECKLACE(72, 105, 26, new Item(1664), new Item(1615), GOLD_BAR),
        DRAGONSTONE_BRACELET(74, 110, 52, new Item(11115), new Item(1615), GOLD_BAR),
        DRAGONSTONE_AMULET(80, 150, 39, new Item(1683), new Item(1615), GOLD_BAR),
        ONYX_RING(67, 115, 13, new Item(6575), new Item(6573), GOLD_BAR),
        ONYX_NECKLACE(82, 120, 27, new Item(6577), new Item(6573), GOLD_BAR),
        ONYX_BRACELET(84, 125, 53, new Item(11130), new Item(6573), GOLD_BAR),
        ONYX_AMULET(90, 165, 40, new Item(6579), new Item(6573), GOLD_BAR),
        ZENYTE_RING(89, 150, 14, new Item(19538), new Item(19493), GOLD_BAR),
        ZENYTE_NECKLACE(92, 165, 28, new Item(19535), new Item(19493), GOLD_BAR),
        ZENYTE_BRACELET(95, 180, 54, new Item(19532), new Item(19493), GOLD_BAR),
        ZENYTE_AMULET(98, 200, 41, new Item(19501), new Item(19493), GOLD_BAR),
        SLAYER_RING(75, 15, 15, new Item(11866), new Item(4155), GOLD_BAR),
        ETERNAL_SLAYER_RING(75, 15, 15, new Item(21268), new Item(21270), GOLD_BAR);
    ...
    public enum PotteryFiringData {
        ...
        public static final HashMap<Integer, PotteryFiringData> VALUES = new HashMap<>(VALUES_ARR.length);
    ...
    public enum PotteryShapingData {
        ...
        public static final HashMap<Integer, PotteryShapingData> VALUES = new HashMap<>(VALUES_ARR.length);
    ...
    public enum SpinningData {
        ...
        public static final HashMap<Integer, SpinningData> VALUES = new HashMap<>(VALUES_ARR.length);
    ...
    public enum WeavingData {
        ...
        public static final HashMap<Integer, WeavingData> VALUES = new HashMap<>(VALUES_ARR.length);
