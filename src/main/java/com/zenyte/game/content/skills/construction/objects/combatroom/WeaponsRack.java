...
public final class WeaponsRack implements ObjectInteraction {
    ...
    public Object[] getObjects() {
        return new Object[]{13381, 13382, 13383};
    }
    ...
    public void handleObjectAction(Player player, Construction construction, RoomReference reference, WorldObject object, int optionId, String option) {
        ...
        player.getDialogueManager().start(new OptionDialogue(player, "Select an Option",
                new String[]{
                        "Red boxing gloves.",
                        "Blue boxing gloves.",
                        objectId >= 13382 ? "A wooden sword." : null,
                        objectId >= 13382 ? "A wooden shield." : null,
                        objectId >= 13383 ? "A pugel stick." : null
                },
                new Runnable[]{
                        () -> add(player, 0),
                        () -> add(player, 1),
