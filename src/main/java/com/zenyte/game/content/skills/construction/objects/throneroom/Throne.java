...
public final class Throne implements ObjectInteraction {
    ...
    private static final Animation[] ANIMS = new Animation[]{
            new Animation(4111), new Animation(4112), new Animation(4113), new Animation(4114),
            new Animation(4115), new Animation(4116), new Animation(4117)
    };
    ...
    public Object[] getObjects() {
        return new Object[]{13665, 13666, 13667, 13668, 13669, 13670, 13671};
    }
