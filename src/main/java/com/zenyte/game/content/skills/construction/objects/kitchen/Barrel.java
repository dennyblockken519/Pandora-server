...
public final class Barrel implements ItemOnObjectAction {
    ...
    public Object[] getObjects() {
        return new Object[]{13568, 13569, 13570, 13571, 13572, 13573};
    }
    ...
    private static final class BarrelFillingAction extends Action {
        ...
        private static final Animation[] ANIMS = new Animation[]{
                new Animation(3661), new Animation(3666), new Animation(3662), new Animation(3663),
                new Animation(3664), new Animation(3665)
        };

        private static final Item[] DRINKABLES = new Item[]{
                new Item(7740), new Item(7752), new Item(7744), new Item(7746), new Item(7748), new Item(7754)
        };
