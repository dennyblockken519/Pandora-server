...
public final class TopiaryBush implements ObjectInteraction {
    ...
    public Object[] getObjects() {
        return new Object[]{29230, 29231, 29232, 29233, 29234, 29235, 29236, 31985};
    }
    ...
    private static final class TopiarySelectionD extends Dialogue {

        private static final Animation SECATEURS_ANIM = new Animation(2278);
        private static final Animation MAGIC_SECATEURS_ANIM = new Animation(3341);
        ...
        private void clipTopiary(final int id) {
            Furniture furniture;
            if (objectId == 29230) {
