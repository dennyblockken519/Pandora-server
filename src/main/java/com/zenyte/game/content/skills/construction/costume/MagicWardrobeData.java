...
public enum MagicWardrobeData {
    ...
    public static final Map<Integer, MagicWardrobeData> MAP = new HashMap<>(VALUES.length * 5);
    public static final Map<Integer, MagicWardrobeData> DISPLAY_MAP = new HashMap<>(VALUES.length);
