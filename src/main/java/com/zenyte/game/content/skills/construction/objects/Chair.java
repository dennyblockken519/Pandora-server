...
public final class Chair implements ObjectInteraction {
    ...
    private static final Animation[] ANIMS = new Animation[]{
            new Animation(4073), new Animation(4075), new Animation(4079), new Animation(4081),
            new Animation(4083), new Animation(4085), new Animation(4087)
    };
    ...
    public Object[] getObjects() {
        return new Object[]{6752, 6753, 6754, 6755, 6756, 6757, 6758};
    }
