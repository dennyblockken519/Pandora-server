...
public enum TeleportCollection implements Teleport {
    TELEOTHER_LUMBRIDGE(TeleportType.TELEOTHER_TELEPORT, new Location(3222, 3218, 0), 0, 0, DISTANCE, WILDERNESS_LEVEL, UNRESTRICTED) {
        @Override
        public String toString() {
            return "Lumbridge";
        }
    },
    TELEOTHER_FALADOR(TeleportType.TELEOTHER_TELEPORT, new Location(2965, 3379, 0), 0, 0, DISTANCE, WILDERNESS_LEVEL, UNRESTRICTED) {
        @Override
        public String toString() {
            return "Falador";
        }
    },
    TELEOTHER_CAMELOT(TeleportType.TELEOTHER_TELEPORT, new Location(2757, 3478, 0), 0, 0, DISTANCE, WILDERNESS_LEVEL, UNRESTRICTED) {
        @Override
        public String toString() {
            return "Camelot";
        }
    },
    TELE_GROUP_MOONCLAN(TeleportType.GROUP_TELEPORT, new Location(2114, 3914, 0), 0, 0, DISTANCE, WILDERNESS_LEVEL, UNRESTRICTED) {
        @Override
        public String toString() {
            return "Moonclan Island";
        }
    },
    TELE_GROUP_WATERBIRTH(TeleportType.GROUP_TELEPORT, new Location(2546, 3758, 0), 0, 0, DISTANCE, WILDERNESS_LEVEL, UNRESTRICTED) {
        @Override
        public String toString() {
            return "Waterbirth Island";
        }
    },
    TELE_GROUP_BARBARIAN(TeleportType.GROUP_TELEPORT, new Location(2518, 3570, 0), 0, 0, DISTANCE, WILDERNESS_LEVEL, UNRESTRICTED) {
        @Override
        public String toString() {
    ...
    public int getRandomizationDistance() {
        return this.randomizationDistance;
    }
