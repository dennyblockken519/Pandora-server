...
public final class SOSLadder implements ObjectAction {
    ...
    public void handleObjectAction(final Player player, final WorldObject object, final String name, final int optionId, final String option) {
        final SOSLadder.Ladder ladder = Utils.findMatching(Ladder.VALUES, l -> l.objectTile.matches(object));
        if (ladder == null) {
    ...
    public Object[] getObjects() {
        return new Object[]{20784, 20785, 19003, 19001, 19004, 23705, 23703, 23706, 23921, 23732, 20782};
    }
    ...
    private enum Ladder {
        ...
        Ladder(final Location objectTile, final Location destination, final String message) {
