        ...
        bind("Talk-to", (player, npc) -> {
            player.getDialogueManager().start(new Dialogue(player, npc) {
                ...
                public void buildDialogue() {
                    ...
                    DialogueOption[] sceptreOptions = new DialogueOption[]{new DialogueOption("Is my account safe?", key(500)),
                            new DialogueOption("Is this the treasure?", key(600))};
                    ...
                    item(new Item(9005), "You show the fancy boots to Solztun.");// or 9006
