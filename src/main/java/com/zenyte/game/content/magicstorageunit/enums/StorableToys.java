...
public enum StorableToys implements StorageUnitElement {
    ...
    SNOW_IMP_COSTUME(ItemId.SNOW_IMP_COSTUME_HEAD_21847, new StorableSetPiece(ItemId.SNOW_IMP_COSTUME_HEAD_21847), new StorableSetPiece(ItemId.SNOW_IMP_COSTUME_BODY_21849), new StorableSetPiece(ItemId.SNOW_IMP_COSTUME_LEGS_21851), new StorableSetPiece(ItemId.SNOW_IMP_COSTUME_GLOVES_21855), new StorableSetPiece(ItemId.SNOW_IMP_COSTUME_FEET_21857), new StorableSetPiece(ItemId.SNOW_IMP_COSTUME_TAIL_21853)),
