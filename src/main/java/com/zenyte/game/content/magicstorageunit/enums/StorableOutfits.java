...
public enum StorableOutfits implements StorageUnitElement {
    ...
    DUSK_MYSTIC_ROBES(ItemId.MYSTIC_HAT_DUSK, new StorableSetPiece(ItemId.MYSTIC_HAT_DUSK), new StorableSetPiece(ItemId.MYSTIC_ROBE_TOP_DUSK), new StorableSetPiece(ItemId.MYSTIC_ROBE_BOTTOM_DUSK), new StorableSetPiece(ItemId.MYSTIC_GLOVES_DUSK), new StorableSetPiece(ItemId.MYSTIC_BOOTS_DUSK)),
    ...
    ORNATE_OUTFIT(ItemId.ORNATE_HELM, new StorableSetPiece(ItemId.ORNATE_HELM), new StorableSetPiece(ItemId.ORNATE_TOP), new StorableSetPiece(ItemId.ORNATE_LEGS), new StorableSetPiece(ItemId.ORNATE_BOOTS), new StorableSetPiece(ItemId.ORNATE_GLOVES), new StorableSetPiece(ItemId.ORNATE_CAPE));
