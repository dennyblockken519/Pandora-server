...
public enum Stage {
    ...
    BIRD_ASLEEP,
    FEED_BIRD(20),
    BIRD_FED_SPEAK_TO_BUNNY_JR(25),
    GATHER_IMPLINGS(30),
    IMPLINGS_GATHERED_SPEAK_TO_BUNNY_JR(35),
    FIX_INCUBATOR(40),
    SPOKEN_WITH_INCUBATOR_WORKER(40),
    INCUBATOR_FIXED_SPEAK_TO_BUNNY_JR(50),
    RETRAIN_SQUIRRELS(55),
    SQUIRRELS_RETRAINED_SPEAK_T0_BUNNY_JR(65),
    MEET_ME_IN_MY_OFFICE(70),
    POST_MEETING_CUTSCENE(75),
    POST_UNDRESS_CUTSCENE(80),
    EVENT_COMPLETE(85);
