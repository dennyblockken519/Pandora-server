            ...
            if (progress == AChristmasWarble.ChristmasWarbleProgress.FIND_OUT_ABOUT_SCOURGES_PAST) {
                player.getDialogueManager().start(new Dialogue(player, npc) {
                    ...
                    public void buildDialogue() {
                        ...
                        npc("Scourge? I'm glad to say I've never had the misfortune of meeting thatsh rotter up 'til now. Though...I have heard rumours of the ill deeds he's commited on " + GameConstants.SERVER_NAME, Expression.HIGH_REV_MAD);
                        player("What's he done?");
                        npc("He consorts with Zamorakian mages, goblins and necromancers. He'sh the sort who'd swap his grandma for a turnip  if he could finda buyer. Evil to the core, that man.", Expression.HIGH_REV_MAD);
