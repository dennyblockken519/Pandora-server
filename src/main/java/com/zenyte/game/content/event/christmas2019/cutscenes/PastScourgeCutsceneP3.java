...
public class PastScourgeCutsceneP3 extends Cutscene {
    ...
    public PastScourgeCutsceneP3(final Player player, final ScourgeHouseInstance instance, final Runnable unfadeRunnable) {
        this.player = player;
    ...
    public void build() {
        ...
        addActions(7, new DialogueAction(new Dialogue(player) {
            ...
            public void buildDialogue() {
                npcWithId(ChristmasConstants.PERSONAL_SNOW_IMP, impName, "He's trapped the Queen of Snow's mates in magical Christmas-y fires!", Expression.HIGH_REV_NORMAL);
