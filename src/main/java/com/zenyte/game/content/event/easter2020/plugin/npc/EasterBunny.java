...
public class EasterBunny extends NPCPlugin {
    ...
    @Override
    public int[] getNPCs() {
        return new int[]{EasterConstants.SAD_EASTER_BUNNY,  // base
                15178, EasterConstants.HAPPY_EASTER_BUNNY, EasterConstants.EASTER_BUNNY_OUTSIDE_CUTSCENE, EasterConstants.POST_QUEST_EASTER_BUNNY, 15177};
    }
}
