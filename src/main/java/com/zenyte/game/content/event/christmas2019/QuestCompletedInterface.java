...
public class QuestCompletedInterface extends Interface {
    ...
    protected void attach() {
        put(2, "Quest completed title");
        put(3, "Quest completed item");
        put(8, "Award line 1");
        put(9, "Award line 2");
        put(10, "Award line 3");
        put(11, "Award line 4");
    ...
    public void open(Player player) {
        ...
        @SuppressWarnings("unchecked") final List<String> rewards = (List<String>) player.getTemporaryAttributes().get("quest completed rewards");
