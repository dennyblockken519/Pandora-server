...
public class EasterBird extends NPCPlugin implements ItemOnNPCAction {
        ...
        bind("Talk-to", (player, npc) -> player.getDialogueManager().start(new Dialogue(player, npc) {
            ...
            public void buildDialogue() {
                if (SplittingHeirs.progressedAtLeast(player, Stage.BIRD_FED_SPEAK_TO_BUNNY_JR)) {
                    ...
                    player("Guess I'd better go look at the to-do list before interfering with things, like the Easter Bunny's son said.");
                    return;
                }
    ...
    public enum Varbit {
        EMPTY_BOWL(EasterConstants.EASTER_BIRD_SEED_BOWL_VARBIT, 0),
        SUNFLOWER_SEED_BOWL(EasterConstants.EASTER_BIRD_SEED_BOWL_VARBIT, 1),
        CRACKER_BITS_BOWL(EasterConstants.EASTER_BIRD_SEED_BOWL_VARBIT, 2),
        WORM_BITS_BOWL(EasterConstants.EASTER_BIRD_SEED_BOWL_VARBIT, 3),
        POPPY_SEED_BOWL(EasterConstants.EASTER_BIRD_SEED_BOWL_VARBIT, 4),
        WATER_BOWL(EasterConstants.EASTER_BIRD_WATER_BOWL_VARBIT);
        ...
        Varbit(final int varbit, final int value) {
            this.varbit = varbit;
            this.value = value;
        }
