        ...
        switch (AChristmasWarble.getProgress(player)) {
            ...
            case FROZEN_GUESTS:
                player.getDialogueManager().start(new Dialogue(player, ChristmasConstants.PERSONAL_SNOW_IMP) {
                    @Override
                    public void buildDialogue() {
                        npc(ChristmasUtils.getImpName(player), "We can't go back up there right now, we have to help the guests!", Expression.HIGH_REV_NORMAL);
                    }
                });
                return;
            ...
            default:
                player.getDialogueManager().start(new Dialogue(player, ChristmasConstants.PERSONAL_SNOW_IMP) {
                    @Override
                    public void buildDialogue() {
                        npc(ChristmasUtils.getImpName(player), "Scourge is up there, bud. We can't go up unprepared or he'll zap us.", Expression.HIGH_REV_NORMAL);
                    }
                });
        }
    }
    ...
    private boolean checkEquipment(final Player player) {
        ...
        if (player.getEquipment().getItem(EquipmentSlot.CAPE) != null) {
            player.getDialogueManager().start(new Dialogue(player, ChristmasConstants.PERSONAL_SNOW_IMP) {
                ...
                public void buildDialogue() {
                    player.faceEntity(player.getFollower());
                    npc(ChristmasUtils.getImpName(player), "You won't look much like a Ghost if ya wearing a cape, matey.", Expression.HIGH_REV_SCARED);
        ...
        if (player.getEquipment().getItem(EquipmentSlot.WEAPON) != null) {
            player.getDialogueManager().start(new Dialogue(player, ChristmasConstants.PERSONAL_SNOW_IMP) {
                ...
                public void buildDialogue() {
                    player.faceEntity(player.getFollower());
                    npc(ChristmasUtils.getImpName(player), "You won't look much like a Ghost if ya holding a weapon, matey.", Expression.HIGH_REV_SCARED);
        ...
        if (player.getEquipment().getItem(EquipmentSlot.SHIELD) != null) {
            player.getDialogueManager().start(new Dialogue(player, ChristmasConstants.PERSONAL_SNOW_IMP) {
                ...
                public void buildDialogue() {
                    player.faceEntity(player.getFollower());
                    npc(ChristmasUtils.getImpName(player), "You won't look much like a Ghost if ya wielding a shield, matey.", Expression.HIGH_REV_SCARED);
