...
public class EasterImpling extends NPCPlugin {
     ...
     */
    public enum Npc {
        FIRST(15206, 15056, new Location(2220, 4377)),
        SECOND(15207, 15057, new Location(2231, 4386)),
        THIRD(15208, 15058, new Location(2223, 4388)),
        FOURTH(15209, 15059, new Location(2233, 4366)),
        FIFTH(15210, 15060, new Location(2219, 4360));
        public static final Int2ObjectOpenHashMap<Npc> forNpcId;
        public static final Npc[] values = Npc.values();

        static {
            Utils.populateMap(values, forNpcId = new Int2ObjectOpenHashMap<>(values.length), Npc::getNpcId);
        }
        ...
        Npc(final int npcId, final int varbitId, final Location location) {
            this.npcId = npcId;
