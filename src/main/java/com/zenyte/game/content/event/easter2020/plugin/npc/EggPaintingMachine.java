...
public class EggPaintingMachine extends NPCPlugin {
    ...
    @Override
    public int[] getNPCs() {
        return new int[]{EasterConstants.EGG_PAINTING_MACHINE_BASE_WEST, EasterConstants.EGG_PAINTING_MACHINE_BASE_EAST, EasterConstants.EGG_PAINTING_MACHINE_WEST, EasterConstants.EGG_PAINTING_MACHINE_EAST, 15241, 15237};
    }
