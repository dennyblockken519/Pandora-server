...
public class OutsideCutscene extends Cutscene {
    ...
    public OutsideCutscene(final Player player, final OutsideInstance instance, final Runnable unfadeRunnable) {
        this.player = player;
    ...
    public static final class UndressDialogue extends Dialogue {
        ...
        public void buildDialogue() {
            npc("Ahh...that's better, much less sticky. Now, as you've helped me so much, I should reward you. You've been very helpful.", Expression.EASTER_BUNNY_VERY_HAPPY);
            player("Aww, it was nothing, really.");
            npc("Oh? So you don't want your reward?", Expression.EASTER_BUNNY_VERY_HAPPY);
            player("I-");
            npc("Well, I guess it's very much a carrot and stick situation: you've dealt with the sticky, now you get your carrot.", Expression.EASTER_BUNNY_VERY_HAPPY).executeAction(() -> {
