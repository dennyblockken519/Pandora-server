 ...
 * @since 26/03/2020
 */
public class EggPlantArea extends Area implements RandomEventRestrictionPlugin, CannonRestrictionPlugin, DropPlugin {
    ...
    public EggPlantArea() {
        GlobalItem.createPersistentGlobalItemSpawn(new GlobalItem(new Item(EasterConstants.EasterItem.INCUBATOR_BLUEPRINTS.getItemId()), new Location(2195, 4400), 1));
        GlobalItem.createPersistentGlobalItemSpawn(new GlobalItem(new Item(EasterConstants.EasterItem.IMPLING_JAR.getItemId()), new Location(2206, 4390), 1));
        GlobalItem.createPersistentGlobalItemSpawn(new GlobalItem(new Item(EasterConstants.EasterItem.IMPLING_JAR.getItemId()), new Location(2205, 4391), 1));
        GlobalItem.createPersistentGlobalItemSpawn(new GlobalItem(new Item(EasterConstants.EasterItem.IMPLING_NET.getItemId()), new Location(2213, 4399), 1));
