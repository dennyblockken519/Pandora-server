...
public class AChristmasWarble {
    ...
    public enum ChristmasWarbleProgress {
        START(1),
        SPOKEN_TO_PERSONAL_IMP(2),
        SPOKEN_TO_SCOURGE(3),
        HAS_GHOST_COSTUME(4),
        FIND_OUT_ABOUT_SCOURGES_PAST(5),
        GHOST_OF_CHRISTMAS_PAST(6),
        FROZEN_GUESTS(7),
        GHOST_OF_CHRISTMAS_PRESENT(8),
        CHRISTMAS_PRESENT_FAILED(9),
        GHOST_OF_CHRISTMAS_FUTURE(10),
        SANTA_FREED(11),
        CAN_OPEN_PRESENT(12),
        EVENT_COMPLETE(100);
        ...
        ChristmasWarbleProgress(final int stage) {
            this.stage = stage;
        }
