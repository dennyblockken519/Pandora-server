...
public class AlchemicalHydraInstance extends DynamicArea implements CycleProcessPlugin, LogoutPlugin, DeathPlugin, CannonRestrictionPlugin, LootBroadcastPlugin {
    ...
    public void constructed() {
        ...
        final int direction = Utils.getFaceDirection(destination.getX() - currentTile.getX(), destination.getY() - currentTile.getY());
        ...
        WorldTasksManager.schedule(new WorldTask() {
            ...
            public void run() {
                ...
                if (ticks == 0) {
                    ...
                    player.getDeathMechanics().service(ItemRetrievalService.RetrievalServiceType.ORRVOR_QUO_MATEN, source);
    ...
    public VentObject getGreenVent() {
        return this.greenVent;
    }

    public VentObject getBlueVent() {
        return this.blueVent;
    }
    ...
    public void setVentDelay(final int ventDelay) {
