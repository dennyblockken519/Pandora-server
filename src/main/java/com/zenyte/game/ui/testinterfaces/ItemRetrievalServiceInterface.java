...
public class ItemRetrievalServiceInterface extends Interface {
    ...
    public void open(Player player) {
        ...
        player.getPacketDispatcher().sendComponentSettings(getInterface(), getComponent("Items"), 0, ContainerType.ITEM_RETRIEVAL_SERVICE.getSize(), AccessMask.CLICK_OP2, AccessMask.CLICK_OP9, AccessMask.CLICK_OP10);
    }
        ...
        bind("Take-All/Unlock", player -> {
            ...
            if (service.isLocked()) {
                ...
                if (cost > total && total >= 0) {
                    player.sendMessage("You need at least " + cost + " coins to unlock your retrieval service.");
                    return;
                }
