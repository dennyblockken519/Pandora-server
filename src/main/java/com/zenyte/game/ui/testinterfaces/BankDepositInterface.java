...
public class BankDepositInterface extends Interface {
    ...
    public void open(Player player) {
        ...
        player.getPacketDispatcher().sendComponentSettings(id, getComponent("Interact with Item"), 0, ContainerType.INVENTORY.getSize(), CLICK_OP1, CLICK_OP2, CLICK_OP3, CLICK_OP4, CLICK_OP5, CLICK_OP6, CLICK_OP9, CLICK_OP10, DRAG_DEPTH1, DRAG_TARGETABLE);
    }
    ...
    public void close(final Player player, final Optional<GameInterface> replacement) {
        ...
        player.getInterfaceHandler().sendInterface(InterfacePosition.EQUIPMENT_TAB, Equipment.INTERFACE);
    }
    ...
    private enum ItemOption {
        ...
        private static ItemOption of(final int option) {
            final BankDepositInterface.ItemOption opt = Utils.findMatching(values, v -> v.optionId == option);
            if (opt == null) {
