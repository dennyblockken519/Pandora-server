...
public class GrandExchangeOffersViewerInterface extends Interface {
    public static void search(final Player player, final int itemId, final ExchangeType exchangeType, SortType sortType) {
        ...
        if (sortType == null) {
            ...
            if (obj instanceof SortType savedSortType) {
    ...
    protected void build() {
        ...
        bind("Sort by quantity", player -> {
            ...
            if (!(obj instanceof ExchangeType type)) {
                return;
            }
            final int itemId = player.getNumericTemporaryAttribute("ge_offers_selected_item").intValue();
