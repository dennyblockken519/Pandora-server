...
public class AutocastInterface extends Interface {
    ...
    public static boolean canCast(@NotNull final Player player, @NotNull final CombatSpell spell) {
    ...
    public void open(Player player) {
        ...
        player.getPacketDispatcher().sendComponentSettings(id, getComponent("Set autocast spell"), 0, AUTOCASTABLE_SPELLS_ENUM.getLargestIntValue(), AccessMask.CLICK_OP1);
    }
    ...
    protected void build() {
        ...
        bind("Set autocast spell", ((player, slotId, itemId, option) -> {
            ...
            final Int2ObjectOpenHashMap<Object> params = definitions.getParameters();
    ...
    private enum AutocastPage {
        ANCIENT(4675, new EnumBuilder<CombatSpell>().add(ANCIENT_AUTOCASTABLE_SPELLS).build(), (player, name) -> onSpellbook(player, Spellbook.ANCIENT) && (name.equals("Master wand") || name.equals("Kodai wand") || name.equals("Ancient staff") || player.getCombatDefinitions().hasFullAhrimsAndDamned())),
        ...
        REGULAR(-1, new EnumBuilder<CombatSpell>().add(NORMAL_AUTOCASTABLE_SPELLS).build(), (player, name) -> onSpellbook(player, Spellbook.NORMAL) && !name.equals("Ancient staff"));
        ...
        AutocastPage(final int baseItemId, final ImmutableSet<CombatSpell> spells, final BiPredicate<Player, String> predicate) {
         ...
         */
        private static Optional<AutocastPage> getPage(final Player player) {
