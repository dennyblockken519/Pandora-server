...
public class EvilBobIsland extends Area implements DeathPlugin, TeleportPlugin, RandomEventRestrictionPlugin {
    ...
    private static Location getEntryLocation(@NotNull final Player player) {
    ...
    public static void teleport(@NotNull final Player player) {
    ...
    private static FishSpot getDirection(@NotNull final Player player) {
    ...
    private enum FishSpot {
        ...
        FishSpot(final Predicate<Player> predicate, final Location cameraPosition, final Location cameraLook) {
    ...
    public static final class BobTheCat extends NPCPlugin {
        private static Dialogue getDialogue(final Player player, final NPC bob) {
