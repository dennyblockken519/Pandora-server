...
public enum InstantMovementObjects {
    ...
    LIZARDMAN_HANDHOLDS_EAST(27362, new Location(1471, 3687, 0), new Location(1476, 3687, 0)),
    LIZARDMAN_HANDHOLDS_UP_EAST(27362, new Location(1475, 3687, 0), new Location(1470, 3687, 0)),
    ...
    REVENANT_OPENING_SOUTH_UP(31557, new Location(3194, 10055, 0), new Location(3075, 3653, 0)),
    REVENANT_OPENING_SOUTH_DOWN(31555, new Location(3073, 3654, 0), new Location(3196, 10056, 0)),
    REVENANT_OPENING_NORTH_UP(31558, new Location(3240, 10235, 0), new Location(3126, 3833, 0)),
    REVENANT_OPENING_NORTH_DOWN(31556, new Location(3124, 3831, 0), new Location(3241, 10234, 0)),
    ...
    public static final Map<Integer, InstantMovementObjects> entries = new HashMap<>();
