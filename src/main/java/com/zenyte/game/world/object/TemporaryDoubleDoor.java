...
public final class TemporaryDoubleDoor {
    ...
    public static WorldObject getNearbyDoor(final Player player, final WorldObject handledDoor) {
        if (handledDoor.getRotation() == 1 || handledDoor.getRotation() == 3) {
            ...
            if (object == null || !object.getName(player).equals(handledDoor.getName(player))) {
    ...
    public static WorldObject getNearbyDoor(final WorldObject handledDoor) {
        if (handledDoor.getRotation() == 1 || handledDoor.getRotation() == 3) {
            WorldObject object = World.getObjectWithType(new Location(handledDoor.getX() - 1, handledDoor.getY(), handledDoor.getPlane()), handledDoor.getType());
    ...
    public static void handleDoubleDoor(final Player player, final WorldObject object) {
        final WorldObject nearbyDoor = getNearbyDoor(player, object);
        if (nearbyDoor == null) {
            return;
        }
    ...
    private static Location getWalkLocation(final Player player, final WorldObject object) {
