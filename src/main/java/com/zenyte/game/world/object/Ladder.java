 ...
 */
public enum Ladder {
    EDGEVILLE_UNDERGROUND(new LadderObject(17385, new Location(3097, 9867, 0)), new Location(3099, 3487, 0)),
    ...
    public static final Map<Integer, Ladder> LADDER_MAP = new HashMap<>(VALUES.length);
    ...
    public static void use(final Player player, final String option, final WorldObject ladder, final Location destination) {
        player.lock(1);
