...
public enum Trapdoor {
    ...
    static {
        Utils.populateMap(values, trapdoors = new Int2ObjectOpenHashMap<>(values.length), trapdoor -> trapdoor.trapdoorLocation.getPositionHash());
    }
    ...
    Trapdoor(final int open, final int closed, final Location trapdoorLocation, final Location destination) {
        this.open = open;
        this.closed = closed;
    ...
    private static Location tile(final int x, final int y, final int z) {
