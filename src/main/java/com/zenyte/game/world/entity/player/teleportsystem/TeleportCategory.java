...
public enum TeleportCategory {
    ...
    WOODCUTTING,
    BACK;
    public static final TeleportCategory[] VALUES = new TeleportCategory[]{CITIES, SKILLING, TRAINING, MINIGAMES, BOSSES, DUNGEONS, WILDERNESS, MISC};
    public static final TeleportCategory[] SKILLING_C = new TeleportCategory[]{BACK, AGILITY, WOODCUTTING};
