...
public final class LoyaltyManager {
    ...
    public static final long LOYALTY_POINTS_INTERVAL_TICKS = (long) (TimeUnit.MINUTES.toMillis(LOYALTY_POINTS_INTERVAL_MINUTES) / Constants.TICK);
    /**
    ...
    public void informSession(final int count) {
        ...
        final int points = (int) (LOYALTY_POINTS_PER_INTERVAL * multiplier(count));
