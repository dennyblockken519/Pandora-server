...
public final class Appearance {
    ...
    private final transient RSBuffer buffer = new RSBuffer(150);
     ...
     *
     * @param data the stream to which this information is written to.
     */
     ...
     * head.
     *
     * @param tempData temporary data stream to write to.
     */
    ...
    public void setAppearance(final short[] appearance) {
    ...
    public void setColours(final byte[] colours) {
