...
public class Equipment extends ContainerWrapper {
    ...
    private static final Map<Integer, Integer> EQUIPMENT_SCREEN_BUTTONS = ImmutableMap.<Integer, Integer>builder().put(11, EquipmentSlot.HELMET.getSlot()).put(12, EquipmentSlot.CAPE.getSlot()).put(13, EquipmentSlot.AMULET.getSlot()).put(14, EquipmentSlot.WEAPON.getSlot()).put(15, EquipmentSlot.PLATE.getSlot()).put(16, EquipmentSlot.SHIELD.getSlot()).put(17, EquipmentSlot.LEGS.getSlot()).put(18, EquipmentSlot.HANDS.getSlot()).put(19, EquipmentSlot.BOOTS.getSlot()).put(20, EquipmentSlot.RING.getSlot()).put(21, EquipmentSlot.AMMUNITION.getSlot()).build();
    private static final Map<Integer, Integer> EQUIPMENT_TAB_BUTTONS = ImmutableMap.<Integer, Integer>builder().put(6, EquipmentSlot.HELMET.getSlot()).put(7, EquipmentSlot.CAPE.getSlot()).put(8, EquipmentSlot.AMULET.getSlot()).put(9, EquipmentSlot.WEAPON.getSlot()).put(10, EquipmentSlot.PLATE.getSlot()).put(11, EquipmentSlot.SHIELD.getSlot()).put(12, EquipmentSlot.LEGS.getSlot()).put(13, EquipmentSlot.HANDS.getSlot()).put(14, EquipmentSlot.BOOTS.getSlot()).put(15, EquipmentSlot.RING.getSlot()).put(16, EquipmentSlot.AMMUNITION.getSlot()).build();
    ...
    public final boolean wear(final int slotId) {
        ...
        if (equipmentSlot == 3) {
            ...
            if (weapon != null) {
                ...
                final int maximumStyles = id == -1 ? 3 : AttackStyleDefinition.values[varbit < 0 || varbit >= AttackStyleDefinition.values.length ? 0 : varbit].getStyles().length;
