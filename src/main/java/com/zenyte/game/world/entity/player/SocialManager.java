...
public class SocialManager {
    ...
    public void updateStatus() {
        final SocialManager.PrivateStatus privateStatus = SocialManager.PrivateStatus.fromId(player.getSettings().valueOf(Setting.PRIVATE_FILTER));
    ...
    public void addFriend(@NotNull final String name) {
        CoresManager.getLoginManager().load(name, true, optional -> {
            ...
            final String formattedUsername = target.getUsername();
            ...
            final Optional<Player> loggedInPlayer = World.getPlayer(formattedUsername);
    ...
    public boolean isVisible(final Player otherPlayer) {
        ...
        final SocialManager.PrivateStatus privateStatus = SocialManager.PrivateStatus.fromId(otherPlayer.getSettings().valueOf(Setting.PRIVATE_FILTER));
    ...
    public void addIgnore(@NotNull final String requestedName) {
        ...
        CoresManager.getLoginManager().load(name, true, optional -> {
            ...
            final Player target = optional.get();
            ignores.add(name);
            final UpdateIgnoreList.IgnoreEntry entry = new UpdateIgnoreList.IgnoreEntry(target.getUsername(), true);
