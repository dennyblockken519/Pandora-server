...
public final class MusicHandler {
    public static final int[] VARP_IDS = new int[]{20, 21, 22, 23, 24, 25, 298, 311, 346, 414, 464, 598, 662, 721, 906, 1009, 1338, 1681, 2065};
    /**
    ...
    private void playRandomTrack() {
        final Set<Music> list = World.getRegion(player.getLocation().getRegionId()).getMusicTracks();
        ...
        final OptionalInt slot = Enums.MUSIC_SLOT_NAME_ENUM.getKey(randomTrack.getName());
    ...
    private int unlockedMusicCount() {
        int count = 0;
