...
public class GameShop {
    ...
    public void openShop(final Player player) {
        ...
        player.getPacketDispatcher().sendComponentSettings(INTERFACE, 16, 0, 41, AccessMask.CLICK_OP1, AccessMask.CLICK_OP2, AccessMask.CLICK_OP3, AccessMask.CLICK_OP4, AccessMask.CLICK_OP5, AccessMask.CLICK_OP10);
