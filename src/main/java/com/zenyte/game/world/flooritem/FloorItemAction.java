...
public class FloorItemAction {
    ...
    public static void handle(final Player player, final int itemId, final Location tile, final int optionId, final boolean forcerun) {
        ...
        LOGGER.info(item.getName() + "(" + itemId + "), " + option + "(" + optionId + "), " + tile);
