...
public final class Huffman {
     ...
     */
    public static int decompress(final byte[] buffer, final int bufferOffset, final byte[] messageBytes, int messageOffset, int messageLength) {
        if (messageLength == 0) {
            return 0;
        } else {
            int int_3 = 0;
     ...
     */
    public static int compress(final byte[] messageBytes, int messageOffset, int messageLength, final byte[] buffer, final int bufferOffset) {
        int int_3 = 0;
